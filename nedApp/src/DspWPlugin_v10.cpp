...
//      BLXXX:Det:DspX:| sig nam|                                 | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("TsyncMode",        '1', 0x0,  1,  8, 0);  // TSYNC mode                 (0=internal,1=external)
    createConfigParam("MaxDataPktSize",   '1', 0x0,  3,  9, 0);  // Max data packet size       (0=1000 bytes, 1=2000 bytes, 3=3000 bytes)
    createConfigParam("TsyncLimit",       '1', 0x0, 20, 12, 166666); // TSYNC limit            (scale:100,unit:ns)
    ...
    createConfigParam("Ch1:OptEn",        '1', 0x3,  1,  4, 1);  // Channel 1 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch2:OptEn",        '1', 0x3,  1,  5, 1);  // Channel 2 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch3:OptEn",        '1', 0x3,  1,  6, 1);  // Channel 3 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch4:OptEn",        '1', 0x3,  1,  7, 1);  // Channel 4 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch5:OptEn",        '1', 0x3,  1,  8, 1);  // Channel 5 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch6:OptEn",        '1', 0x3,  1,  9, 1);  // Channel 6 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch7:OptEn",        '1', 0x3,  1, 10, 1);  // Channel 7 optical TX en    (0=enable,1=disable)
    createConfigParam("Ch8:OptEn",        '1', 0x3,  1, 11, 1);  // Channel 8 optical TX en    (0=enable,1=disable)
