...
//    BLXXX:Det:RocXXX:| sig nam|                              | EPICS record description | (bi and mbbi description)
    ...
    createChanStatusParam("Ch1:AdcFifoHasData",   1, 0x0,  1,  4); // Chan1 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch1:AdcFifoAlmostFull",1, 0x0,  1,  5); // Chan1 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch1:PosDiscEvent",     1, 0x0,  1,  6); // Chan1 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch1:AdcFifoFull",      1, 0x0,  1,  7); // Chan1 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch1:EventFifoFull",    1, 0x0,  1,  8); // Chan1 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch1:AdcMin",           1, 0x0,  1,  9); // Chan1 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch1:AdcMax",           1, 0x0,  1, 10); // Chan1 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch1:Event",            1, 0x0,  1, 14); // Chan1 got event              (0=no,1=yes)
    createChanStatusParam("Ch1:MultiDiscEvent",   1, 0x0,  1, 15); // Chan1 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch2:AdcFifoHasData",   2, 0x0,  1,  4); // Chan2 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch2:AdcFifoAlmostFull",2, 0x0,  1,  5); // Chan2 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch2:PosDiscEvent",     2, 0x0,  1,  6); // Chan2 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch2:AdcFifoFull",      2, 0x0,  1,  7); // Chan2 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch2:EventFifoFull",    2, 0x0,  1,  8); // Chan2 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch2:AdcMin",           2, 0x0,  1,  9); // Chan2 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch2:AdcMax",           2, 0x0,  1, 10); // Chan2 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch2:Event",            2, 0x0,  1, 14); // Chan2 got event              (0=no,1=yes)
    createChanStatusParam("Ch2:MultiDiscEvent",   2, 0x0,  1, 15); // Chan2 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch3:AdcFifoHasData",   3, 0x0,  1,  4); // Chan3 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch3:AdcFifoAlmostFull",3, 0x0,  1,  5); // Chan3 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch3:PosDiscEvent",     3, 0x0,  1,  6); // Chan3 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch3:AdcFifoFull",      3, 0x0,  1,  7); // Chan3 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch3:EventFifoFull",    3, 0x0,  1,  8); // Chan3 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch3:AdcMin",           3, 0x0,  1,  9); // Chan3 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch3:AdcMax",           3, 0x0,  1, 10); // Chan3 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch3:Event",            3, 0x0,  1, 14); // Chan3 got event              (0=no,1=yes)
    createChanStatusParam("Ch3:MultiDiscEvent",   3, 0x0,  1, 15); // Chan3 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch4:AdcFifoHasData",   4, 0x0,  1,  4); // Chan4 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch4:AdcFifoAlmostFull",4, 0x0,  1,  5); // Chan4 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch4:PosDiscEvent",     4, 0x0,  1,  6); // Chan4 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch4:AdcFifoFull",      4, 0x0,  1,  7); // Chan4 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch4:EventFifoFull",    4, 0x0,  1,  8); // Chan4 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch4:AdcMin",           4, 0x0,  1,  9); // Chan4 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch4:AdcMax",           4, 0x0,  1, 10); // Chan4 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch4:Event",            4, 0x0,  1, 14); // Chan4 got event              (0=no,1=yes)
    createChanStatusParam("Ch4:MultiDiscEvent",   4, 0x0,  1, 15); // Chan4 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch5:AdcFifoHasData",   5, 0x0,  1,  4); // Chan5 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch5:AdcFifoAlmostFull",5, 0x0,  1,  5); // Chan5 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch5:PosDiscEvent",     5, 0x0,  1,  6); // Chan5 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch5:AdcFifoFull",      5, 0x0,  1,  7); // Chan5 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch5:EventFifoFull",    5, 0x0,  1,  8); // Chan5 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch5:AdcMin",           5, 0x0,  1,  9); // Chan5 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch5:AdcMax",           5, 0x0,  1, 10); // Chan5 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch5:Event",            5, 0x0,  1, 14); // Chan5 got event              (0=no,1=yes)
    createChanStatusParam("Ch5:MultiDiscEvent",   5, 0x0,  1, 15); // Chan5 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch6:AdcFifoHasData",   6, 0x0,  1,  4); // Chan6 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch6:AdcFifoAlmostFull",6, 0x0,  1,  5); // Chan6 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch6:PosDiscEvent",     6, 0x0,  1,  6); // Chan6 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch6:AdcFifoFull",      6, 0x0,  1,  7); // Chan6 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch6:EventFifoFull",    6, 0x0,  1,  8); // Chan6 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch6:AdcMin",           6, 0x0,  1,  9); // Chan6 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch6:AdcMax",           6, 0x0,  1, 10); // Chan6 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch6:Event",            6, 0x0,  1, 14); // Chan6 got event              (0=no,1=yes)
    createChanStatusParam("Ch6:MultiDiscEvent",   6, 0x0,  1, 15); // Chan6 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch7:AdcFifoHasData",   7, 0x0,  1,  4); // Chan7 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch7:AdcFifoAlmostFull",7, 0x0,  1,  5); // Chan7 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch7:PosDiscEvent",     7, 0x0,  1,  6); // Chan7 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch7:AdcFifoFull",      7, 0x0,  1,  7); // Chan7 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch7:EventFifoFull",    7, 0x0,  1,  8); // Chan7 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch7:AdcMin",           7, 0x0,  1,  9); // Chan7 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch7:AdcMax",           7, 0x0,  1, 10); // Chan7 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch7:Event",            7, 0x0,  1, 14); // Chan7 got event              (0=no,1=yes)
    createChanStatusParam("Ch7:MultiDiscEvent",   7, 0x0,  1, 15); // Chan7 got multi-discrim ev   (0=no,1=yes)
    ...
    createChanStatusParam("Ch8:AdcFifoHasData",   8, 0x0,  1,  4); // Chan8 FIFO has data          (0=no,1=yes)
    createChanStatusParam("Ch8:AdcFifoAlmostFull",8, 0x0,  1,  5); // Chan8 FIFO almost full       (0=no,1=yes)
    createChanStatusParam("Ch8:PosDiscEvent",     8, 0x0,  1,  6); // Chan8 positive discrim ev    (0=no,1=yes)
    createChanStatusParam("Ch8:AdcFifoFull",      8, 0x0,  1,  7); // Chan8 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch8:EventFifoFull",    8, 0x0,  1,  8); // Chan8 FIFO full detectec     (0=no,1=yes)
    createChanStatusParam("Ch8:AdcMin",           8, 0x0,  1,  9); // Chan8 got ADC min            (0=no,1=yes)
    createChanStatusParam("Ch8:AdcMax",           8, 0x0,  1, 10); // Chan8 got ADC max            (0=no,1=yes)
    ...
    createChanStatusParam("Ch8:Event",            8, 0x0,  1, 14); // Chan8 got event              (0=no,1=yes)
    createChanStatusParam("Ch8:MultiDiscEvent",   8, 0x0,  1, 15); // Chan8 got multi-discrim ev   (0=no,1=yes)
