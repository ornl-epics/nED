...
//    BLXXX:Det:RocXXX:| sig nam|                              | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("Ch3:FpgaStatus",       0x0,  1,  2); // Channel 3 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("Ch4:FpgaStatus",       0x0,  1,  3); // Channel 4 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("Ch5:FpgaStatus",       0x0,  1,  4); // Channel 5 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("Ch6:FpgaStatus",       0x0,  1,  5); // Channel 6 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("Ch7:FpgaStatus",       0x0,  1,  6); // Channel 7 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("Ch8:FpgaStatus",       0x0,  1,  7); // Channel 8 FPGA status        (0=ready,1=not ready [alarm])
    createStatusParam("InvalidHardware",      0x1,  1,  0); // Invalid hardware             (0=no error,1=error)
    ...
    createStatusParam("ErrNoStart",           0x1,  1,  3); // Calc: Bad word count.        (0=no error,1=error)
    createStatusParam("ErrTofOverflow",       0x1,  1,  4); // LVDS FIFO went full.         (0=no error,1=error)
    createStatusParam("ErrBusBusy",           0x1,  1,  5); // LVDS FIFO went full.         (0=no error,1=error)
    createStatusParam("ErrDataType",          0x1,  1,  6); // LVDS FIFO went full.         (0=no error,1=error)
    createStatusParam("ErrParity",            0x1,  1,  7); // LVDS FIFO went full.         (0=no error,1=error)
    ...
    createStatusParam("ErrCmdTimeout",        0x1,  1, 10); // Command length error         (0=no error,1=error)
    createStatusParam("ErrProgramming",       0x1,  1, 11); // WRITE_CNFG during ACQ        (0=no error,1=error)
    createStatusParam("HvStatus",             0x1,  1, 12); // HV status bit                (0=no error,1=error)
    createStatusParam("ErrLength",            0x1,  1, 13); // LVDS packet length error     (0=no error,1=error)
    createStatusParam("ErrBadPacket",         0x1,  1, 14); // Calculation bad packet       (0=no error,1=error)
    createStatusParam("ErrCalc",              0x1,  1, 15); // Calculation error            (0=no error,1=error)
    ...
    createStatusParam("Ch1:AdcFifoHasData",   1, 0x0,  1,  4); // Chan1 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch1:AdcFifoAlmostFull",1, 0x0,  1,  5); // Chan1 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch1:PosDiscEvent",     1, 0x0,  1,  6); // Chan1 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch1:AdcFifoFull",      1, 0x0,  1,  7); // Chan1 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch1:EventFifoFull",    1, 0x0,  1,  8); // Chan1 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch1:AdcMin",           1, 0x0,  1,  9); // Chan1 got ADC min            (0=no,1=yes)
    createStatusParam("Ch1:AdcMax",           1, 0x0,  1, 10); // Chan1 got ADC max            (0=no,1=yes)
    createStatusParam("Ch1:ErrProgramming",   1, 0x0,  1, 11); // Chan1 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch1:ErrCmdLength",     1, 0x0,  1, 12); // Chan1 Command length error   (0=no error,1=error)
    createStatusParam("Ch1:ErrCmdBad",        1, 0x0,  1, 13); // Chan1 bad command error      (0=no error,1=error)
    createStatusParam("Ch1:Event",            1, 0x0,  1, 14); // Chan1 got event              (0=no,1=yes)
    createStatusParam("Ch1:MultiDiscEvent",   1, 0x0,  1, 15); // Chan1 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch2:AdcFifoHasData",   2, 0x0,  1,  4); // Chan2 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch2:AdcFifoAlmostFull",2, 0x0,  1,  5); // Chan2 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch2:PosDiscEvent",     2, 0x0,  1,  6); // Chan2 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch2:AdcFifoFull",      2, 0x0,  1,  7); // Chan2 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch2:EventFifoFull",    2, 0x0,  1,  8); // Chan2 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch2:AdcMin",           2, 0x0,  1,  9); // Chan2 got ADC min            (0=no,1=yes)
    createStatusParam("Ch2:AdcMax",           2, 0x0,  1, 10); // Chan2 got ADC max            (0=no,1=yes)
    createStatusParam("Ch2:ErrProgramming",   2, 0x0,  1, 11); // Chan2 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch2:ErrCmdLength",     2, 0x0,  1, 12); // Chan2 Command length error   (0=no error,1=error)
    createStatusParam("Ch2:ErrCmdBad",        2, 0x0,  1, 13); // Chan2 bad command error      (0=no error,1=error)
    createStatusParam("Ch2:Event",            2, 0x0,  1, 14); // Chan2 got event              (0=no,1=yes)
    createStatusParam("Ch2:MultiDiscEvent",   2, 0x0,  1, 15); // Chan2 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch3:AdcFifoHasData",   3, 0x0,  1,  4); // Chan3 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch3:AdcFifoAlmostFull",3, 0x0,  1,  5); // Chan3 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch3:PosDiscEvent",     3, 0x0,  1,  6); // Chan3 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch3:AdcFifoFull",      3, 0x0,  1,  7); // Chan3 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch3:EventFifoFull",    3, 0x0,  1,  8); // Chan3 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch3:AdcMin",           3, 0x0,  1,  9); // Chan3 got ADC min            (0=no,1=yes)
    createStatusParam("Ch3:AdcMax",           3, 0x0,  1, 10); // Chan3 got ADC max            (0=no,1=yes)
    createStatusParam("Ch3:ErrProgramming",   3, 0x0,  1, 11); // Chan3 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch3:ErrCmdLength",     3, 0x0,  1, 12); // Chan3 Command length error   (0=no error,1=error)
    createStatusParam("Ch3:ErrCmdBad",        3, 0x0,  1, 13); // Chan3 bad command error      (0=no error,1=error)
    createStatusParam("Ch3:Event",            3, 0x0,  1, 14); // Chan3 got event              (0=no,1=yes)
    createStatusParam("Ch3:MultiDiscEvent",   3, 0x0,  1, 15); // Chan3 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch4:AdcFifoHasData",   4, 0x0,  1,  4); // Chan4 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch4:AdcFifoAlmostFull",4, 0x0,  1,  5); // Chan4 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch4:PosDiscEvent",     4, 0x0,  1,  6); // Chan4 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch4:AdcFifoFull",      4, 0x0,  1,  7); // Chan4 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch4:EventFifoFull",    4, 0x0,  1,  8); // Chan4 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch4:AdcMin",           4, 0x0,  1,  9); // Chan4 got ADC min            (0=no,1=yes)
    createStatusParam("Ch4:AdcMax",           4, 0x0,  1, 10); // Chan4 got ADC max            (0=no,1=yes)
    createStatusParam("Ch4:ErrProgramming",   4, 0x0,  1, 11); // Chan4 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch4:ErrCmdLength",     4, 0x0,  1, 12); // Chan4 Command length error   (0=no error,1=error)
    createStatusParam("Ch4:ErrCmdBad",        4, 0x0,  1, 13); // Chan4 bad command error      (0=no error,1=error)
    createStatusParam("Ch4:Event",            4, 0x0,  1, 14); // Chan4 got event              (0=no,1=yes)
    createStatusParam("Ch4:MultiDiscEvent",   4, 0x0,  1, 15); // Chan4 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch5:AdcFifoHasData",   5, 0x0,  1,  4); // Chan5 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch5:AdcFifoAlmostFull",5, 0x0,  1,  5); // Chan5 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch5:PosDiscEvent",     5, 0x0,  1,  6); // Chan5 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch5:AdcFifoFull",      5, 0x0,  1,  7); // Chan5 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch5:EventFifoFull",    5, 0x0,  1,  8); // Chan5 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch5:AdcMin",           5, 0x0,  1,  9); // Chan5 got ADC min            (0=no,1=yes)
    createStatusParam("Ch5:AdcMax",           5, 0x0,  1, 10); // Chan5 got ADC max            (0=no,1=yes)
    createStatusParam("Ch5:ErrProgramming",   5, 0x0,  1, 11); // Chan5 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch5:ErrCmdLength",     5, 0x0,  1, 12); // Chan5 Command length error   (0=no error,1=error)
    createStatusParam("Ch5:ErrCmdBad",        5, 0x0,  1, 13); // Chan5 bad command error      (0=no error,1=error)
    createStatusParam("Ch5:Event",            5, 0x0,  1, 14); // Chan5 got event              (0=no,1=yes)
    createStatusParam("Ch5:MultiDiscEvent",   5, 0x0,  1, 15); // Chan5 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch6:AdcFifoHasData",   6, 0x0,  1,  4); // Chan6 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch6:AdcFifoAlmostFull",6, 0x0,  1,  5); // Chan6 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch6:PosDiscEvent",     6, 0x0,  1,  6); // Chan6 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch6:AdcFifoFull",      6, 0x0,  1,  7); // Chan6 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch6:EventFifoFull",    6, 0x0,  1,  8); // Chan6 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch6:AdcMin",           6, 0x0,  1,  9); // Chan6 got ADC min            (0=no,1=yes)
    createStatusParam("Ch6:AdcMax",           6, 0x0,  1, 10); // Chan6 got ADC max            (0=no,1=yes)
    createStatusParam("Ch6:ErrProgramming",   6, 0x0,  1, 11); // Chan6 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch6:ErrCmdLength",     6, 0x0,  1, 12); // Chan6 Command length error   (0=no error,1=error)
    createStatusParam("Ch6:ErrCmdBad",        6, 0x0,  1, 13); // Chan6 bad command error      (0=no error,1=error)
    createStatusParam("Ch6:Event",            6, 0x0,  1, 14); // Chan6 got event              (0=no,1=yes)
    createStatusParam("Ch6:MultiDiscEvent",   6, 0x0,  1, 15); // Chan6 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch7:AdcFifoHasData",   7, 0x0,  1,  4); // Chan7 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch7:AdcFifoAlmostFull",7, 0x0,  1,  5); // Chan7 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch7:PosDiscEvent",     7, 0x0,  1,  6); // Chan7 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch7:AdcFifoFull",      7, 0x0,  1,  7); // Chan7 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch7:EventFifoFull",    7, 0x0,  1,  8); // Chan7 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch7:AdcMin",           7, 0x0,  1,  9); // Chan7 got ADC min            (0=no,1=yes)
    createStatusParam("Ch7:AdcMax",           7, 0x0,  1, 10); // Chan7 got ADC max            (0=no,1=yes)
    createStatusParam("Ch7:ErrProgramming",   7, 0x0,  1, 11); // Chan7 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch7:ErrCmdLength",     7, 0x0,  1, 12); // Chan7 Command length error   (0=no error,1=error)
    createStatusParam("Ch7:ErrCmdBad",        7, 0x0,  1, 13); // Chan7 bad command error      (0=no error,1=error)
    createStatusParam("Ch7:Event",            7, 0x0,  1, 14); // Chan7 got event              (0=no,1=yes)
    createStatusParam("Ch7:MultiDiscEvent",   7, 0x0,  1, 15); // Chan7 got multi-discrim ev   (0=no,1=yes)
    ...
    createStatusParam("Ch8:AdcFifoHasData",   8, 0x0,  1,  4); // Chan8 FIFO has data          (0=no,1=yes)
    createStatusParam("Ch8:AdcFifoAlmostFull",8, 0x0,  1,  5); // Chan8 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch8:PosDiscEvent",     8, 0x0,  1,  6); // Chan8 positive discrim ev    (0=no,1=yes)
    createStatusParam("Ch8:AdcFifoFull",      8, 0x0,  1,  7); // Chan8 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch8:EventFifoFull",    8, 0x0,  1,  8); // Chan8 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch8:AdcMin",           8, 0x0,  1,  9); // Chan8 got ADC min            (0=no,1=yes)
    createStatusParam("Ch8:AdcMax",           8, 0x0,  1, 10); // Chan8 got ADC max            (0=no,1=yes)
    createStatusParam("Ch8:ErrProgramming",   8, 0x0,  1, 11); // Chan8 WRITE_CNFG during ACQ  (0=no error,1=error)
    createStatusParam("Ch8:ErrCmdLength",     8, 0x0,  1, 12); // Chan8 Command length error   (0=no error,1=error)
    createStatusParam("Ch8:ErrCmdBad",        8, 0x0,  1, 13); // Chan8 bad command error      (0=no error,1=error)
    createStatusParam("Ch8:Event",            8, 0x0,  1, 14); // Chan8 got event              (0=no,1=yes)
    createStatusParam("Ch8:MultiDiscEvent",   8, 0x0,  1, 15); // Chan8 got multi-discrim ev   (0=no,1=yes)
