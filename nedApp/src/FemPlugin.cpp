...
//     BLXXX:Det:FemXX:| sig name |                      | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("Ch5:ErrStr",     0x2,  1,  6); // Chan5 got START during packt (0=no error,1=error)
    ...
    createStatusParam("Ch7:ErrStr",     0x3,  1,  6); // Chan7 got START during packt (0=no error,1=error)
    ...
    createStatusParam("C10:ErrFif",     0x4,  1, 15); // Chan10 FIFO went full        (0=no,1=yes)
    createStatusParam("C10:ErrStr",     0x4,  1, 14); // Chan10 got START during pckt (0=no error,1=error)
    createStatusParam("C10:ErrNoS",     0x4,  1, 13); // Chan10 got data without STRT (0=no error,1=error)
    createStatusParam("C10:ErrTim",     0x4,  1, 12); // Chan10 got TIMEOUT           (0=no timeout,1=timeout)
    createStatusParam("C10:ErrLen",     0x4,  1, 11); // Chan10 long packet error     (0=no error,1=error)
    createStatusParam("C10:ErrSho",     0x4,  1, 10); // Chan10 short packet error    (0=no error,1=error)
    createStatusParam("C10:ErrCmd",     0x4,  1,  9); // Chan10 DATA/COMMAND type err (0=no error,1=error)
    createStatusParam("C10:ErrPar",     0x4,  1,  8); // Chan10 parity error          (0=no error,1=error)
    createStatusParam("Ch9:ErrFif",     0x4,  1,  7); // Chan9 FIFO went full         (0=no,1=yes)
    createStatusParam("Ch9:ErrStr",     0x4,  1,  6); // Chan9 got START during packt (0=no error,1=error)
    ...
    createStatusParam("FltrNacks",      0x5, 16, 14); // Filtered NACK                (0=no,1=yes)
    createStatusParam("FltrNack",       0x5,  1, 14); // Filtered NACK                (0=no,1=yes)
    createStatusParam("ErrEeprom",      0x5,  1, 13); // EEPROM error                 (0=no error,1=error)
    createStatusParam("ErrNoHw",        0x5,  1, 12); // Missing hardware             (0=not missing,1=missing)
    createStatusParam("ErrUncfg",       0x5,  1, 11); // Unconfigured                 (0=configured,1=not confiured)
    createStatusParam("ErrProg",        0x5,  1, 10); // Programming error            (0=no error,1=error)
    createStatusParam("ErrCmdLen",      0x5,  1,  9); // Command length error         (0=no error,1=error)
    createStatusParam("ErrBadCmd",      0x5,  1,  8); // Unknown command              (0=no error,1=error)
    createStatusParam("Ctr:ErrFif",     0x5,  1,  7); // CTRL FIFO went full          (0=no,1=yes)
    createStatusParam("Ctr:ErrStr",     0x5,  1,  6); // CTRL got START during packet (0=no error,1=error)
    createStatusParam("Ctr:ErrNoS",     0x5,  1,  5); // CTRL got data without START  (0=no error,1=error)
    createStatusParam("Ctr:ErrTim",     0x5,  1,  4); // CTRL got TIMEOUT             (0=no timeout,1=timeout)
    createStatusParam("Ctr:ErrLen",     0x5,  1,  3); // CTRL long packet error       (0=no error,1=error)
    createStatusParam("Ctr:ErrSho",     0x5,  1,  2); // CTRL short packet error      (0=no error,1=error)
    createStatusParam("Ctr:ErrCmd",     0x5,  1,  1); // CTRL DATA/COMMAND type err   (0=no error,1=error)
    createStatusParam("Ctr:ErrPar",     0x5,  1,  0); // CTRL parity error            (0=no error,1=error)

    // Verify, dcomserver thinks     {SYSLEVEL_WARN,            {7,7,-1},{6,8,-1},    CHECK_VALUE,    "Filtered NACKs"},
    createStatusParam("FltrdNacks",     0x6,  8,  0); // Filtered NACKS

    createStatusParam("Ch8:GotCmd",     0x7,  1, 15); // Chan8 got command packet     (0=no,1=yes)
    createStatusParam("Ch8:GotDat",     0x7,  1, 14); // Chan8 got data packet        (0=no,1=yes)
    createStatusParam("Ch7:GotCmd",     0x7,  1, 13); // Chan7 got command packet     (0=no,1=yes)
    createStatusParam("Ch7:GotDat",     0x7,  1, 12); // Chan7 got data packet        (0=no,1=yes)
    createStatusParam("Ch6:GotCmd",     0x7,  1, 11); // Chan6 got command packet     (0=no,1=yes)
    createStatusParam("Ch6:GotDat",     0x7,  1, 10); // Chan6 got data packet        (0=no,1=yes)
    createStatusParam("Ch5:GotCmd",     0x7,  1,  9); // Chan5 got command packet     (0=no,1=yes)
    createStatusParam("Ch5:GotDat",     0x7,  1,  8); // Chan5 got data packet        (0=no,1=yes)
    createStatusParam("Ch4:GotCmd",     0x7,  1,  7); // Chan4 got command packet     (0=no,1=yes)
    createStatusParam("Ch4:GotDat",     0x7,  1,  6); // Chan4 got data packet        (0=no,1=yes)
    createStatusParam("Ch3:GotCmd",     0x7,  1,  5); // Chan3 got command packet     (0=no,1=yes)
    createStatusParam("Ch3:GotDat",     0x7,  1,  4); // Chan3 got data packet        (0=no,1=yes)
    createStatusParam("Ch2:GotCmd",     0x7,  1,  3); // Chan2 got command packet     (0=no,1=yes)
    createStatusParam("Ch2:GotDat",     0x7,  1,  2); // Chan2 got data packet        (0=no,1=yes)
    createStatusParam("Ch1:GotCmd",     0x7,  1,  1); // Chan1 got command packet     (0=no,1=yes)
    createStatusParam("Ch1:GotDat",     0x7,  1,  0); // Chan1 got data packet        (0=no,1=yes)

    createStatusParam("FiltrdAcks",     0x8,  8,  8); // Filtered ACKS
    ...
    createStatusParam("Ctr:GotCmd",     0x8,  1,  5); // CTRL got command packet      (0=no,1=yes)
    createStatusParam("Ctr:GotDat",     0x8,  1,  4); // CTRL got data packet         (0=no,1=yes)
    createStatusParam("C10:GotCmd",     0x8,  1,  3); // Chan10 got command packet    (0=no,1=yes)
    createStatusParam("C10:GotDat",     0x8,  1,  2); // Chan10 got data packet       (0=no,1=yes)
    createStatusParam("Ch9:GotCmd",     0x8,  1,  1); // Chan9 got command packet     (0=no,1=yes)
    createStatusParam("Ch9:GotDat",     0x8,  1,  0); // Chan9 got data packet        (0=no,1=yes)

    createStatusParam("Ch8:FifCmd",     0x9,  1, 15); // Chan8 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch8:FifoNE",     0x9,  1, 14); // Chan8 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch7:FifoAF",     0x9,  1, 13); // Chan7 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch7:FifoNE",     0x9,  1, 12); // Chan7 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch6:FifoAF",     0x9,  1, 11); // Chan6 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch6:FifoNE",     0x9,  1, 10); // Chan6 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch5:FifoAF",     0x9,  1,  9); // Chan5 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch5:FifoNE",     0x9,  1,  8); // Chan5 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch4:FifoAF",     0x9,  1,  7); // Chan4 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch4:FifoNE",     0x9,  1,  6); // Chan4 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch3:FifoAF",     0x9,  1,  5); // Chan3 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch3:FifoNE",     0x9,  1,  4); // Chan3 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch2:FifoAF",     0x9,  1,  3); // Chan2 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch2:FifoNE",     0x9,  1,  2); // Chan2 FIFO has data          (0=empty,1=has data)
    createStatusParam("Ch1:FifoAF",     0x9,  1,  1); // Chan1 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch1:FifoNE",     0x9,  1,  0); // Chan1 FIFO not empty         (0=empty,1=has data)
    ...
    createStatusParam("Ch9:FifoAF",     0xA,  1,  1); // Chan9 FIFO almost full       (0=no,1=yes)
    createStatusParam("Ch9:FifoNE",     0xA,  1,  0); // Chan9 FIFO has data          (0=empty,1=has data)

    createStatusParam("FltrdRsps",      0xB, 16,  8); // Filtered responses
    createStatusParam("SysrstB",        0xB,  2,  6); // Sysrst_B low/high detected   (0=empty,1=low,2=high,3=low and high)
    createStatusParam("TxEnable",       0xB,  2,  4); // TXEN low/high detected       (0=empty,1=low,2=high,3=low and high)
    createStatusParam("Tsync",          0xB,  2,  2); // TSYNC                        (0=empty,1=low,2=high,3=low and high)
    createStatusParam("Tclk",           0xB,  2,  0); // TCLK                         (0=empty,1=low,2=high,3=low and high)
...
{
//     BLXXX:Det:FemXX:| sig name |                                | EPICS record description | (bi and mbbi description)
    createConfigParam("LvdsMonit",    'E', 0x0,  1,  8, 0);     // LVDS debug monitor           (0=disable,1=enable)
    ...
    createConfigParam("VerbRsp",      'F', 0x0,  1, 14, 0);     // Verbose command response     (0=disable,1=enable)
    createConfigParam("Ch10:Dis",     'F', 0x0,  1, 13, 0);     // Chan10 disable               (0=enable,1=disable)
    createConfigParam("Ch9:Dis",      'F', 0x0,  1, 12, 0);     // Chan9 disable                (0=enable,1=disable)
    createConfigParam("Ch8:Dis",      'F', 0x0,  1, 11, 0);     // Chan8 disable                (0=enable,1=disable)
    createConfigParam("Ch7:Dis",      'F', 0x0,  1, 10, 0);     // Chan7 disable                (0=enable,1=disable)
    createConfigParam("Ch6:Dis",      'F', 0x0,  1,  9, 0);     // Chan6 disable                (0=enable,1=disable)
    createConfigParam("Ch5:Dis",      'F', 0x0,  1,  8, 0);     // Chan5 disable                (0=enable,1=disable)
    createConfigParam("Ch4:Dis",      'F', 0x0,  1,  7, 0);     // Chan4 disable                (0=enable,1=disable)
    createConfigParam("Ch3:Dis",      'F', 0x0,  1,  6, 0);     // Chan3 disable                (0=enable,1=disable)
    createConfigParam("Ch2:Dis",      'F', 0x0,  1,  5, 0);     // Chan2 disable                (0=enable,1=disable)
    createConfigParam("Ch1:Dis",      'F', 0x0,  1,  4, 0);     // Chan1 disable                (0=enable,1=disable)
