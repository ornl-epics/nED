...
/**
 * @file ArocPlugin_v22.cpp
 *
 * AROC 2.2 parameters - status register may not be complete, only brought in for grabbing config on TOPAZ
 */
void ArocPlugin::createParams_v22()
{
