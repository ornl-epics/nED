...
//     BLXXX:Det:RocXXX:| sig nam|                     | EPICS record description | (bi and mbbi description)
    ...
    createCounterParam("Ch0:CntFul",  0xE, 16,  0); // Ch0: ADC FIFO full counter
    createCounterParam("Ch1:CntFul",  0xF, 16,  0); // Ch1: ADC FIFO full counter
    createCounterParam("Ch2:CntFul", 0x10, 16,  0); // Ch2: ADC FIFO full counter
    createCounterParam("Ch3:CntFul", 0x11, 16,  0); // Ch3: ADC FIFO full counter
    createCounterParam("Ch4:CntFul", 0x12, 16,  0); // Ch4: ADC FIFO full counter
    createCounterParam("Ch5:CntFul", 0x13, 16,  0); // Ch5: ADC FIFO full counter
    createCounterParam("Ch6:CntFul", 0x14, 16,  0); // Ch6: ADC FIFO full counter
    createCounterParam("Ch7:CntFul", 0x15, 16,  0); // Ch7: ADC FIFO full counter
    createCounterParam("CntMisClk",  0x16, 16,  0); // Link RX clock missing cnt
    createCounterParam("Ch0:CntPE",  0x17, 16,  0); // Ch0: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch1:CntPE",  0x18, 16,  0); // Ch1: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch2:CntPE",  0x19, 16,  0); // Ch2: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch3:CntPE",  0x1A, 16,  0); // Ch3: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch4:CntPE",  0x1B, 16,  0); // Ch4: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch5:CntPE",  0x1C, 16,  0); // Ch5: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch6:CntPE",  0x1D, 16,  0); // Ch6: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch7:CntPE",  0x1E, 16,  0); // Ch7: positive edge counter   (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch0:CntSH",  0x1F, 16,  0); // Ch0: SUM high counter        (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch1:CntSH",  0x20, 16,  0); // Ch1: SUM high counter        (calc:1000*A/52.4288,unit:counts/s,prec:0)
    createCounterParam("Ch2:CntSH",  0x21, 16,  0); // Ch2: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch3:CntSH",  0x22, 16,  0); // Ch3: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch4:CntSH",  0x23, 16,  0); // Ch4: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch5:CntSH",  0x24, 16,  0); // Ch5: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch6:CntSH",  0x25, 16,  0); // Ch6: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch7:CntSH",  0x26, 16,  0); // Ch7: SUM high counter        (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch0:CntSL",  0x27, 16,  0); // Ch0: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch1:CntSL",  0x28, 16,  0); // Ch1: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch2:CntSL",  0x29, 16,  0); // Ch2: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch3:CntSL",  0x2A, 16,  0); // Ch3: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch4:CntSL",  0x2B, 16,  0); // Ch4: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch5:CntSL",  0x2C, 16,  0); // Ch5: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch6:CntSL",  0x2D, 16,  0); // Ch6: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch7:CntSL",  0x2E, 16,  0); // Ch7: SUM low counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch0:Rate",   0x2F, 16,  0); // Ch0: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch1:Rate",   0x30, 16,  0); // Ch1: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch2:Rate",   0x31, 16,  0); // Ch2: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch3:Rate",   0x32, 16,  0); // Ch3: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch4:Rate",   0x33, 16,  0); // Ch4: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch5:Rate",   0x34, 16,  0); // Ch5: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch6:Rate",   0x35, 16,  0); // Ch6: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
    createCounterParam("Ch7:Rate",   0x36, 16,  0); // Ch7: outrate counter         (calc:1000*A/52.4288,unit:counts/s)
