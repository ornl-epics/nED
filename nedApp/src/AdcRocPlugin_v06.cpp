...
//    BLXXX:Det:RocXXX:| sig nam|      | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("ErrNoTsync",           0x5,  1, 11);   // On ACQ, Time Stamp at max
    createStatusParam("ErrCmdBad",            0x5,  1, 12);   // Unrecognized command
    createStatusParam("ErrCmdLength",         0x5,  1, 13);   // Command length error
    createStatusParam("ErrProgramming",       0x5,  1, 14);   // WRITE_CNFG while ACQ
...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("Ch8:DIG:Mode",         'C', 0xB,  2,14, 0);   // Chan8 Digital mode *** UNUSED ***
    ...
    createConfigParam("HpTsyncDelay",         'E', 0x4, 20, 0, 0);    // Heat pulser register
    createConfigParam("NmosOnWidth",          'E', 0x6, 24, 0, 0);
    createConfigParam("PmosOnWidth",          'E', 0x8, 10, 0, 0);
    createConfigParam("Unused",               'E', 0x8,  2,10, 0);
    createConfigParam("NmosOnDelay",          'E', 0x8,  4,12, 0);
    createConfigParam("HpRate",               'E', 0x9, 10, 0, 0);
    createConfigParam("HpEnable",             'E', 0x9,  1,10, 0);
    ...
    createConfigParam("FrameNumbIncr",        'F', 0x3, 10, 0,  1);   // Frame number increment
