...
/**
 * @file RocPlugin_v59.cpp
 *
 * ROC 5.9 parameters
 *
 * The ROC 5.9 firmware is based on 5.6 with added pre-amp commands from 5.8.
 */

void RocPlugin::createParams_v59()
{
    createRegParam("VERSION", "HwRev",  true, 0,  8, 0);   // Hardware revision
    createRegParam("VERSION", "HwVer",  true, 0,  8, 8);   // Hardware version
    createRegParam("VERSION", "FwRev",  true, 1,  8, 0);   // Firmware revision        (low:8,high:10)
