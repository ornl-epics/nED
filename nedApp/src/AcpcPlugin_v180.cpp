...
/**
 * @file AcpcPlugin_v180.cpp
 */

void AcpcPlugin::createParams_v180()
{
    ...
    createRegParam("VERSION", "FwRev",  true, 3,  8,  0); // Firmware revision                  (low:-1,high:1)
    createRegParam("VERSION", "FwVer",  true, 3,  8,  8); // Firmware version                   (low:17,high:19)
