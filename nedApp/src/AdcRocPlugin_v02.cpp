...
void AdcRocPlugin::createStatusParams_v02()
{
...
void AdcRocPlugin::createConfigParams_v02()
{
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
      ...
      createConfigParam("PmRatePeriod",         'C', 0xA, 16, 0, 0);  // Pulsed Magnet Rate Period
      ...
      createConfigParam("AdcRange",             'D', 0x0, 1, 4, 0);     // ADC Range (0=5V,1=10V)
      createConfigParam("PmEnable",             'D', 0x0, 1, 5, 0);     // Pulsed Magnet Enable
      ...
      createConfigParam("TxEnable",             'F', 0x0,  1, 3, 0);    // Tx Enable force (0=force,1=do not force)
      createConfigParam("AcquireMode",          'F', 0x0,  2, 4, 0);    // Acquire Mode (0=idle,1=idle,2=normal,3=trigger)
      createConfigParam("OutputMode",           'F', 0x0,  1,10, 0);    // Output Mode (0=slow,1=40MHz)
