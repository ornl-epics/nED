...
/**
 * @file FemPlugin_v37.cpp
 *
 * FEM 3.7 parameters
 *
 * The FEM 3.7 firmware is identical to FEM 3.6 except that it adds support for
...
void FemPlugin::createStatusParams_v37()
{
//     BLXXX:Det:FemXX:| sig name        |                 | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("Configured",       0x5,  1, 11); // Configured                   (0=configured,1=not configured [alarm])
...
void FemPlugin::createConfigParams_v37()
{
//     BLXXX:Det:FemXX:| sig name |                                | EPICS record description | (bi and mbbi description)
...
void FemPlugin::createCounterParams_v37()
{
...
void FemPlugin::createUpgradeParams_v37() {
