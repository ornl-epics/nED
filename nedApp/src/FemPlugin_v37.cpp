 ...
 * FEM 3.7 parameters
 *
 * The FEM 3.7 firmware is identical to FEM 3.6 except that it provides 2 new
 * commands for downstream T&C handling similar to DSP-T 6.5.
 */

#include "FemPlugin.h"

void FemPlugin::createParams_v37()
{
    ...
    createRegParam("VERSION", "FwRev",  true, 3,  8,  0); // Firmware revision                  (low:6,high:8)
