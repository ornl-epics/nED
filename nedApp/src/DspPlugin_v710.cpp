...
void DspPlugin::createParams_v710() {
    ...
    createConfigParam("Trig0:Select",     '1', 0x16,  4,  8, 0); // Trigger 0 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses)
    createConfigParam("Trig1:Select",     '1', 0x16,  4, 12, 0); // Trigger 1 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses)
    createConfigParam("Trig2:Select",     '1', 0x16,  4, 16, 0); // Trigger 2 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses)
    createConfigParam("Trig3:Select",     '1', 0x16,  4, 20, 0); // Trigger 3 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses)
    createConfigParam("Trig4:Select",     '1', 0x16,  4, 24, 0); // Trigger 4 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses)
