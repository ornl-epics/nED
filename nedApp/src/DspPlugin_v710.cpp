...
void DspPlugin::createParams_v710() {
    ...
    createConfigParam("Trig0:Select",     '1', 0x16,  4,  8, 0); // Trigger 0 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses,9=no pulses)
    createConfigParam("Trig1:Select",     '1', 0x16,  4, 12, 0); // Trigger 1 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses,9=no pulses)
    createConfigParam("Trig2:Select",     '1', 0x16,  4, 16, 0); // Trigger 2 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses,9=no pulses)
    createConfigParam("Trig3:Select",     '1', 0x16,  4, 20, 0); // Trigger 3 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses,9=no pulses)
    createConfigParam("Trig4:Select",     '1', 0x16,  4, 24, 0); // Trigger 4 Pulse select      (0=no beam,1=target 1,2=target 2,3=not used,4=diag pulse1,5=diag pulse2,6=physiscs pulse1,7=physics pulse2,8=all pulses,9=no pulses)
    ...
    createConfigParam("Trig0:Polarity",   '1', 0x1E,  1, 16, 0); // Trigger0 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig1:Polarity",   '1', 0x1E,  1, 17, 0); // Trigger1 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig2:Polarity",   '1', 0x1E,  1, 18, 0); // Trigger2 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig3:Polarity",   '1', 0x1E,  1, 19, 0); // Trigger3 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig4:Polarity",   '1', 0x1E,  1, 20, 0); // Trigger4 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig5:Polarity",   '1', 0x1E,  1, 21, 0); // Trigger5 Pulse Polarity     (0=not inverted,1=inverted)
    createConfigParam("Trig4:Delay",      '1', 0x1B, 16,  0, 0); // Test Pattern Delay          (scale:0.0024094117,unit:ms)
    createConfigParam("Trig4:Period",     '1', 0x1B, 16, 16, 10625); // Test Pattern Pulse Period   (scale:0.0094117,unit:us)
