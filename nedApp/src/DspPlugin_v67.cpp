...
void DspPlugin::createParams_v67() {
    ...
    createRegParam("VERSION", "FwRev",  true, 1,  4, 24); // Firmware revision                  (low:6,high:8)
...
//      BLXXX:Det:DspX:| sig nam|                            | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("OutputMode",     'E', 0x8,  4, 20, 0); // Event format                 (1=meta,2=pixel,3=LPSD verbose [alarm],5=XY PS,8=AROC raw [alarm],10=BNL raw,7=CROC raw)
