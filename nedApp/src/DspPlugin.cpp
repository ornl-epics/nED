...
//      BLXXX:Det:DspX:| sig nam|                             | EPICS record description | (bi and mbbi description)
    ...
    // Chopper parameters
    createConfigParam("Chop0:Dly",  'C', 0x0,  32,  0, 0); // Chop0 delay for N*9.4ns cyc
    createConfigParam("Chop1:Dly",  'C', 0x1,  32,  0, 0); // Chop1 delay for N*9.4ns cyc
    createConfigParam("Chop2:Dly",  'C', 0x2,  32,  0, 0); // Chop2 delay for N*9.4ns cyc
    createConfigParam("Chop3:Dly",  'C', 0x3,  32,  0, 0); // Chop3 delay for N*9.4ns cyc
    createConfigParam("Chop4:Dly",  'C', 0x4,  32,  0, 0); // Chop4 delay for N*9.4ns cyc
    createConfigParam("Chop5:Dly",  'C', 0x5,  32,  0, 0); // Chop5 delay for N*9.4ns cyc
    createConfigParam("Chop6:Dly",  'C', 0x6,  32,  0, 0); // Chop6 delay for N*9.4ns cyc
    createConfigParam("Chop7:Dly",  'C', 0x7,  32,  0, 0); // Chop7 delay for N*9.4ns cyc
    ...
    createConfigParam("Chop1:Freq", 'C', 0x8,   4,  4, 0); // Chop1 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop2:Freq", 'C', 0x8,   4,  8, 0); // Chop2 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop3:Freq", 'C', 0x8,   4, 12, 0); // Chop3 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop4:Freq", 'C', 0x8,   4, 16, 0); // Chop4 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop5:Freq", 'C', 0x8,   4, 20, 0); // Chop5 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop6:Freq", 'C', 0x8,   4, 24, 0); // Chop6 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("Chop7:Freq", 'C', 0x8,   4, 28, 0); // Chop7 frequency selector     (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)

    createConfigParam("ChopDutyCy", 'C', 0x9,  32,  0, 83400); // N*100ns ref pulse high
    createConfigParam("ChopMaxPer", 'C', 0xA,  32,  0, 166800); // N*100ns master/ref delay
    createConfigParam("ChopFixOff", 'C', 0xB,  32,  0, 0); // Chopper TOF fixed offset       - todo: make proper record links to chopper ioc
...
//    createConfigParam1("ChopRtdlFr32",'C', 0x12,  8, 16, 3); // RTDL Frame 32
    ...
    createConfigParam("ChopTrefTr", 'C', 0x13,  2,  0, 1); // Chopper TREF trigger select  (0=Extract,1=Cycle Start,2=Beam On,3=TREF event)
    createConfigParam("ChopTrefFr", 'C', 0x13,  4,  2, 0); // TREF frequency select        (0=60Hz,1=30Hz,2=20Hz,3=15Hz,4=12.5Hz,5=10Hz,6=7.5Hz,7=6Hz,8=5Hz,9=4Hz,10=3Hz,11=2.4Hz,12=2Hz,13=1.5Hz,14=1.25Hz,15=1Hz)
    createConfigParam("ChopRtdlOf", 'C', 0x13,  4,  8, 0); // Chopper RTDL frame offset
    createConfigParam("ChopTrefEv", 'C', 0x13,  8, 12, 39); // Chop TREF event trig [0:255]
    createConfigParam("ChopHystML", 'C', 0x13,  4, 20, 4); // Chop HYST minimum low [0:7]
    createConfigParam("ChopHystMH", 'C', 0x13,  4, 24, 4); // Chop HYST minimum high [0:7]
    createConfigParam("ChopFreqCn", 'C', 0x13,  2, 28, 1); // Chop frequency count control (0=strobe at X, 1=strobe at X-1, 2=strobe at X-2)
    createConfigParam("ChopFreqCy", 'C', 0x13,  1, 30, 1); // Chop frequency cycle select  (0=Present cycle number, 1=Next cycle number)
    createConfigParam("ChopSweep",  'C', 0x13,  1, 31, 0); // Chop sweep enable            (0=TOF fixed off,1=TOF fract off)

    createConfigParam("STsyncDelM",  'C', 0x14, 32,  0, 0); // Synth mast strobe max delay
    createConfigParam("STsyncDelA",  'C', 0x15, 32,  0, 0); // Synth mast strobe delay adj
    createConfigParam("STsyncFraA",  'C', 0x16, 32,  0, 0); // Synth mast strobe fract adj
    createConfigParam("TimeHiFake",  'C', 0x17, 32,  0, 0); // Fake mode time high DWord
    ...
    createConfigParam("Ch3:PixId",  'D', 0x5,  32,  0, 0x50000008); // Chan3 edge pixel id
    createConfigParam("Ch4:PixId",  'D', 0x6,  32,  0, 0x5000000a); // Chan4 edge pixel id
    createConfigParam("Ch5:PixId",  'D', 0x7,  32,  0, 0x5000000c); // Chan5 edge pixel id
    createConfigParam("Ch6:PixId",  'D', 0x8,  32,  0, 0x5000000e); // Chan6 edge pixel id
    createConfigParam("Ch7:PixId",  'D', 0x9,  32,  0, 0x50000010); // Chan7 edge pixel id
    createConfigParam("Ch8:PixId",  'D', 0xA,  32,  0, 0x50000012); // Chan8 edge pixel id
    createConfigParam("Ch9:PixId",  'D', 0xB,  32,  0, 0x50000014); // Chan9 edge pixel id
    createConfigParam("Ch10:PixId", 'D', 0xC,  32,  0, 0x50000016); // Chan10 edge pixel id
    createConfigParam("Ch11:PixId", 'D', 0xD,  32,  0, 0x50000018); // Chan11 edge pixel id
    createConfigParam("Ch12:PixId", 'D', 0xE,  32,  0, 0x5000001a); // Chan12 edge pixel id
    createConfigParam("Ch13:PixId", 'D', 0xF,  32,  0, 0x5000001c); // Chan13 edge pixel id
    createConfigParam("Ch14:PixId", 'D', 0x10, 32,  0, 0x5000001e); // Chan14 edge pixel id
    createConfigParam("Ch15:PixId", 'D', 0x11, 32,  0, 0x50000006); // Chan15 edge pixel id
    createConfigParam("Ch16:PixId", 'D', 0x12, 32,  0, 0); // Chan16 edge pixel id
    createConfigParam("Ch17:PixId", 'D', 0x13, 32,  0, 0); // Chan17 edge pixel id
    createConfigParam("Ch18:PixId", 'D', 0x14, 32,  0, 0); // Chan18 edge pixel id
    createConfigParam("Ch19:PixId", 'D', 0x15, 32,  0, 0); // Chan19 edge pixel id
    createConfigParam("Ch20:PixId", 'D', 0x16, 32,  0, 0); // Chan20 edge pixel id
    createConfigParam("Ch21:PixId", 'D', 0x17, 32,  0, 0); // Chan21 edge pixel id
    createConfigParam("Ch22:PixId", 'D', 0x18, 32,  0, 0); // Chan22 edge pixel id
    createConfigParam("Ch23:PixId", 'D', 0x19, 32,  0, 0); // Chan23 edge pixel id
    createConfigParam("Ch24:PixId", 'D', 0x1A, 32,  0, 0); // Chan24 edge pixel id
    createConfigParam("Ch25:PixId", 'D', 0x1B, 32,  0, 0); // Chan25 edge pixel id
    createConfigParam("Ch26:PixId", 'D', 0x1C, 32,  0, 0); // Chan26 edge pixel id
    createConfigParam("Ch27:PixId", 'D', 0x1D, 32,  0, 0); // Chan27 edge pixel id
    createConfigParam("Ch28:PixId", 'D', 0x1E, 32,  0, 0); // Chan28 edge pixel id
    createConfigParam("Ch29:PixId", 'D', 0x1F, 32,  0, 0); // Chan29 edge pixel id
    createConfigParam("Ch30:PixId", 'D', 0x20, 32,  0, 0); // Chan30 edge pixel id
    createConfigParam("Ch31:PixId", 'D', 0x21, 32,  0, 0); // Chan31 edge pixel id
    ...
    createConfigParam("Lvds3:IgnE", 'E', 0x0,  1, 10, 0); // LVDS chan3 ignore error pkts  (0=ignore,1=keep)
    createConfigParam("Lvds4:IgnE", 'E', 0x0,  1, 13, 0); // LVDS chan4 ignore error pkts  (0=ignore,1=keep)
    createConfigParam("Lvds5:IgnE", 'E', 0x0,  1, 16, 0); // LVDS chan5 ignore error pkts  (0=ignore,1=keep)
    createConfigParam("Lvds0:Dis",  'E', 0x0,  1,  2, 0); // LVDS chan0 disable            (0=enable,1=disable)
    createConfigParam("Lvds1:Dis",  'E', 0x0,  1,  5, 0); // LVDS chan1 disable            (0=enable,1=disable)
    createConfigParam("Lvds2:Dis",  'E', 0x0,  1,  8, 0); // LVDS chan2 disable            (0=enable,1=disable)
    createConfigParam("Lvds3:Dis",  'E', 0x0,  1, 11, 0); // LVDS chan3 disable            (0=enable,1=disable)
    createConfigParam("Lvds4:Dis",  'E', 0x0,  1, 14, 0); // LVDS chan4 disable            (0=enable,1=disable)
    createConfigParam("Lvds5:Dis",  'E', 0x0,  1, 17, 0); // LVDS chan5 disable            (0=enable,1=disable)
    createConfigParam("LvdsCmdMod", 'E', 0x0,  1, 18, 0); // LVDS command parser mode      (0=as command,1=as data)
    createConfigParam("LvdsDatMod", 'E', 0x0,  1, 19, 0); // LVDS data parser mode         (0=as data,1=as command)
    createConfigParam("LvdsDatSiz", 'E', 0x0,  8, 20, 4); // LVDS data pkt num words
    createConfigParam("LvdsPowCtr", 'E', 0x0,  1, 28, 0); // Power Down during reset       (0=power down,1=power up)
    createConfigParam("LvdsPowRst", 'E', 0x0,  1, 29, 0); // Execite power down sequence   (0=execute,1=bypass)
    createConfigParam("LvdsFltAll", 'E', 0x0,  2, 30, 0); // Filter all commands

    createConfigParam("LvdsFltCmd", 'E', 0x1, 16,  0, 0xFFFF); // LVDS command to filter
    createConfigParam("LvdsFltCmM", 'E', 0x1, 16, 16, 0); // LVDS command filter mask

//      BLXXX:Det:DspX:| sig nam|                            | EPICS record description | (bi and mbbi description)
    createConfigParam("LvdsTxCtrl", 'E', 0x2,  1,  0, 0); // LVDS TX control TCLK mode    (0=TCLK from int,1=TCLK from LVDS)
    createConfigParam("LvdsTxTcCt", 'E', 0x2,  2,  2, 0); // LVDS TX control T&C TCLK mod (0=TCLK,1=TCLK,2=always 0,3=always 1)
    createConfigParam("LvdsTsMode", 'E', 0x2,  2,  4, 3); // LVDS TSYNC_O mode            (0=local TSYNC,1=TSYNC from TREF,2=TSYNC from LVDS,3=TSYNC from opt)
    createConfigParam("LvdsTsCtrl", 'E', 0x2,  2,  6, 0); // LVDS TSYNC_NORMAL control    (0=polarity,1=TSYNC WIDTH,2=always 0,3=always 1)
    createConfigParam("LvdsSysrCt", 'E', 0x2,  2,  8, 0); // LVDS T&C SYSRST# buffer ctrl (0=sysrst,1=sysrst,2=always 0,3=always 1)
    createConfigParam("LvdsTxenCt", 'E', 0x2,  2, 10, 0); // LVDS T&C TXEN# control       (0=ChLnk parser,1=ChLnk parser,2=ChLnk RX,3=ChLnk inv RX)
    createConfigParam("LvdsOutClk", 'E', 0x2,  2, 16, 0); // LVDS output clock mode
    createConfigParam("LvdsNRetry", 'E', 0x2,  2, 18, 3); // LVDS downstream retrys
    createConfigParam("Lvds0:WLen", 'E', 0x2,  1, 20, 0); // LVDS chan0 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("Lvds1:WLen", 'E', 0x2,  1, 21, 0); // LVDS chan1 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("Lvds2:WLen", 'E', 0x2,  1, 22, 0); // LVDS chan2 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("Lvds3:WLen", 'E', 0x2,  1, 23, 0); // LVDS chan3 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("Lvds4:WLen", 'E', 0x2,  1, 24, 0); // LVDS chan4 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("Lvds5:WLen", 'E', 0x2,  1, 25, 0); // LVDS chan5 data word length  (0=RX FIFO data,1=set to 4)
    createConfigParam("LvdsClkMar", 'E', 0x2,  2, 26, 0); // LVDS clock margin
    createConfigParam("LvdsTstPat", 'E', 0x2,  1, 30, 0); // LVDS T&C test pattern        (0=disable,1=enable)
    createConfigParam("LvdsTestEn", 'E', 0x2,  1, 31, 0); // LVDS test enable             (0=disable,1=enable)

    createConfigParam("Lvds0:SrcC", 'E', 0x3,  2,  0, 0); // LVDS ch0 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("Lvds1:SrcC", 'E', 0x3,  2,  2, 0); // LVDS ch1 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("Lvds2:SrcC", 'E', 0x3,  2,  4, 0); // LVDS ch2 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("Lvds3:SrcC", 'E', 0x3,  2,  6, 0); // LVDS ch3 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("Lvds4:SrcC", 'E', 0x3,  2,  8, 0); // LVDS ch4 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("Lvds5:SrcC", 'E', 0x3,  2, 10, 0); // LVDS ch5 TSYNC T&C src ctrl  (0=TSYNC_NORMAL,1=TSYNC_LOCAL str,2=TSYNC_LOCA no s,3=TRefStrbFixed)
    createConfigParam("LvdsTsMeta", 'E', 0x3,  2, 14, 0); // LVDS TSYNC metadata src ctrl (0=RTDL,1=LVDS,2=detector TSYNC,3=OFB[0])

    createConfigParam("LvdsTsGen",  'E', 0x4, 32,  0, 20000); // LVDS TSYNC generation divisor   - 40MHz/this value to obtain TSYNC period
    createConfigParam("LvdsTsDel",  'E', 0x5, 32,  0, 0); // LVDS TSYNC delay divisor            - 106.25MHz/this value
    createConfigParam("LvdsTsWid",  'E', 0x6, 32,  0, 0); // LVDS TSYNC width divisor            - 10MHz/this value

    createConfigParam("OptA:Cross", 'E', 0x8,  2,  2, 0); // Crossbar Switch Pass ctrl A  (1=Send to trans A,2=send to trans B)
    createConfigParam("OptB:Cross", 'E', 0x8,  2, 10, 0); // Crossbar Switch Pass ctrl B  (1=Send to trans A,2=send to trans B)
    createConfigParam("OptA:TxMod", 'E', 0x8,  2,  0, 0); // Optical TX A output mode     (0=Normal,1=Timing,2=Chopper,3=Timing master)
    createConfigParam("OptA:EOC",   'E', 0x8,  1,  4, 0); // Optical TX A End of Chain
    createConfigParam("OptA:FltCm", 'E', 0x8,  2,  5, 0); // Optical TX A Command Filter
    createConfigParam("OptB:TxMod", 'E', 0x8,  2,  8, 0); // Optical TX B output mode     (0=Normal,1=Timing,2=Chopper,3=Timing master)
    createConfigParam("OptB:EOC",   'E', 0x8,  1, 12, 0); // Optical TX B End of Chain
    createConfigParam("OptB:FltCm", 'E', 0x8,  2, 13, 0); // Optical TX B Command Filter
    ...
    createConfigParam("OptTxDelCt", 'E', 0x8,  1, 31, 1); // Optical packet send delay ct (0=use OPT_TX_DELAY,1=prev word count)

    createConfigParam("OptMaxSize", 'E', 0x9, 16,  0, 16111); // Optical packet max dwords
    createConfigParam("OptNeuEop",  'E', 0x9,  1, 16, 1); // Optical Neutron send EOP     (0=disabled,1=enabled)
    ...
    createConfigParam("FakeTrig",   'E', 0xA, 32,  0, 0); // Fake Trigger Information

    createConfigParam("SysRstMode", 'F', 0x0,  2,  0, 0); // Reset mode => SYSRST_O#      (0=not used,1=not used,2=from LVDS T&C,3=from optical T&C)
    createConfigParam("SysStrtMod", 'F', 0x0,  3,  4, 0); // Start/Stop mode              (0=normal, 1=fake data mode,2=not defined,3=not defined)
    ...
    createConfigParam("SysRtdlMod", 'F', 0x0,  2, 12, 0); // RTDL mode                    (0=no RTDL,1=master,2=slave,3=fake mode)
    ...
    createConfigParam("SysTofOfEn", 'F', 0x0,  1, 16, 0); // Enable TOF full offset       (0=disable,1=enable)
    createConfigParam("SysFifSync", 'F', 0x0,  1, 17, 0); // FIFO sync switch             (0=disable,1=enable)
    createConfigParam("SysRtdlDat", 'F', 0x0,  1, 18, 1); // Send RTDL command as data    (0=disable,1=enable)
    createConfigParam("SysFixRtdl", 'F', 0x0,  1, 19, 1); // Correct RTDL information     (0=disable,1=enable)
    createConfigParam("SysBadPkt",  'F', 0x0,  1, 30, 0); // Send bad packets             (0=disable,1=enable)
...
//      BLXXX:Det:DspX:| sig nam|                     | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("ProgramErr",  0x0,  1,  2); // WRITE_CNFG during ACQ        (0=no error,1=error)
    createStatusParam("PktLenErr",   0x0,  1,  3); // Packet length error          (0=no error,1=error)
    createStatusParam("ErrBadCmd",   0x0,  1,  4); // Unrecognized command error   (0=no error,1=error)
    createStatusParam("LvdsTxFul",   0x0,  1,  5); // LVDS TxFIFO went full        (0=not full,1=full)
    ...
    createStatusParam("OptA:ErrCn",  0x1,  8,  0); // RX A errors count
    createStatusParam("OptA:ErrFl",  0x1, 13,  8); // Error flags                  (8=packet timeout,9=SOF/address sw,10=EOF/address sw,11=SOF/hdr sw,12=EOF/hdr sw,13=SOF/payload sw,14=EOF/payload sw,15=SOF/CRC switch,16=EOF/CRC switch,17=CRC low word,18=CRC high word,19=pri FIFO al full,20=sec FIFO al full)
    createStatusParam("OptA:Good",   0x1,  1, 21); // Last packet was good         (0=no,1=yes)
    ...
    createStatusParam("OptB:ErrCn",  0x2,  8,  0); // RX B errors count
    createStatusParam("OptB:ErrFl",  0x2, 13,  8); // Error flags                  (8=packet timeout,9=SOF/address sw,10=EOF/address sw,11=SOF/hdr sw,12=EOF/hdr sw,13=SOF/payload sw,14=EOF/payload sw,15=SOF/CRC switch,16=EOF/CRC switch,17=CRC low word,18=CRC high word,19=pri FIFO al full,20=sec FIFO al full)
    createStatusParam("OptB:Good",   0x2,  1, 21); // Last packet was good         (0=no,1=yes)
    ...
    createStatusParam("Ch0:RxFlg",   0x3,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch0:RxStat",  0x3,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch0:RxData",  0x3,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch0:RxAF",    0x3,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch0:RxParD",  0x3,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch0:RxParF",  0x3,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch0:ExtEn",   0x3,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch0:ParsEn",  0x3,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch0:ErrCnt",  0x3, 16, 16); // Data packet errors count

    createStatusParam("Ch1:RxFlg",   0x4,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch1:RxStat",  0x4,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch1:RxData",  0x4,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch1:RxAF",    0x4,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch1:RxParD",  0x4,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch1:RxParF",  0x4,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch1:ExtEn",   0x4,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch1:ParsEn",  0x4,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch1:ErrCnt",  0x4, 16, 16); // Data packet errors count

    createStatusParam("Ch2:RxFlg",   0x5,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch2:RxStat",  0x5,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch2:RxData",  0x5,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch2:RxAF",    0x5,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch2:RxParD",  0x5,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch2:RxParF",  0x5,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch2:ExtEn",   0x5,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch2:ParsEn",  0x5,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch2:ErrCnt",  0x5, 16, 16); // Data packet errors count

    createStatusParam("Ch3:RxFlg",   0x6,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch3:RxStat",  0x6,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch3:RxData",  0x6,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch3:RxAF",    0x6,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch3:RxParD",  0x6,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch3:RxParF",  0x6,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch3:ExtEn",   0x6,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch3:ParsEn",  0x6,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch3:ErrCnt",  0x6, 16, 16); // Data packet errors count

    createStatusParam("Ch4:RxFlg",   0x7,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch4:RxStat",  0x7,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch4:RxData",  0x7,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch4:RxAF",    0x7,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch4:RxParD",  0x7,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch4:RxParF",  0x7,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch4:ExtEn",   0x7,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch4:ParsEn",  0x7,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch4:ErrCnt",  0x7, 16, 16); // Data packet errors count

    createStatusParam("Ch5:RxFlg",   0x8,  8,  0); // Error flags                  (0=parity error,1=packet type err,2=start&last set,3=len >300 words,4=FIFO timeout,5=no first word,6=last befor first,7=out FIFO full)
    createStatusParam("Ch5:RxStat",  0x8,  2,  8); // Status OK                    (0=good cmd packet,1=good data packet)
    createStatusParam("Ch5:RxData",  0x8,  1, 10); // External FIFO has data       (0=empty,1=has data)
    createStatusParam("Ch5:RxAF",    0x8,  1, 11); // External FIFO almost full    (0=not full,1=almost full)
    createStatusParam("Ch5:RxParD",  0x8,  1, 12); // ChLnk pkt pars FIFO has data (0=empty,1=has data)
    createStatusParam("Ch5:RxParF",  0x8,  1, 13); // ChLnk pkt pars FIFO almost f (0=not full,1=almost full)
    createStatusParam("Ch5:ExtEn",   0x8,  1, 14); // External FIFO Read enabled   (0=disabled,1=enabled)
    createStatusParam("Ch5:ParsEn",  0x8,  1, 15); // ChLnk pkt pars FIFO Write en (0=disabled,1=enabled)
    createStatusParam("Ch5:ErrCnt",  0x8, 16, 16); // Data packet errors count
    ...
    createStatusParam("ClkThrMin",   0xC, 32,  0); // Min N*40MHz TSYNC/ref delay
    createStatusParam("ClkThrMax",   0xD, 32,  0); // Max N*40MHz TSYNC/ref delay
