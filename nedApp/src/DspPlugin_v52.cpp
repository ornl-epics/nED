...
//  D:2 = fake_info - not supported even in DSP-T 6.3+
    ...
    createStatusParam("Lvds1:LFReady",  0x4,  1, 20); // LVDS FIFO data ready         (0=no,1=yes)
    createStatusParam("Lvds1:LFAFull",  0x4,  1, 21); // LVDS FIFO almost full        (0=no,1=yes)
    createStatusParam("Lvds1:FReady",   0x4,  1, 22); // FIFO data ready              (0=no,1=yes)
    createStatusParam("Lvds1:FAFull",   0x4,  1, 23); // FIFO almost full             (0=no,1=yes)
