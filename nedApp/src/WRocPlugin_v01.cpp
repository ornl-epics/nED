...
//    createRegParam("VERSION", "ModuleType", true, 0,  8, 0);   // Module type               (low:46,high:48)
    ...
    createConfigParam("Protocol",     '1', 0,  1, 0, 0);    // LVDS Protocol Select   (0=legacy,1=new)
    ...
    createStatusParam("Ch0:Activity",     0,  1, 13);       // Chan0 activity         (0=no events,1=events present)
    createStatusParam("Ch1:Activity",     0,  1, 14);       // Chan1 activity         (0=no events,1=events present)
    createStatusParam("Ch2:Activity",     0,  1, 15);       // Chan2 activity         (0=no events,1=events present)
    createStatusParam("Ch3:Activity",     0,  1, 16);       // Chan3 activity         (0=no events,1=events present)
    createStatusParam("Ch4:Activity",     0,  1, 17);       // Chan4 activity         (0=no events,1=events present)
    createStatusParam("Ch5:Activity",     0,  1, 18);       // Chan5 activity         (0=no events,1=events present)
    createStatusParam("Ch6:Activity",     0,  1, 19);       // Chan6 activity         (0=no events,1=events present)
    createStatusParam("Ch7:Activity",     0,  1, 20);       // Chan7 activity         (0=no events,1=events present)
