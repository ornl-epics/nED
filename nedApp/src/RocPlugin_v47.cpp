...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("Ch1:A:SampleMin",  1, 'D',  0x5, 12, 0, 100);// Chan1 A sample minimum
    createConfigParam("Ch1:A:SampleMax",  1, 'D',  0x6, 12, 0, 100);// Chan1 A sample maximum
    createConfigParam("Ch1:B:SampleMin",  1, 'D',  0x7, 12, 0, 100);// Chan1 B sample minimum
    createConfigParam("Ch1:B:SampleMax",  1, 'D',  0x8, 12, 0, 100);// Chan1 B sample maximum
    ...
    createConfigParam("Ch2:A:SampleMin",  2, 'D',  0x5, 12, 0, 100);// Chan2 A sample minimum
    createConfigParam("Ch2:A:SampleMax",  2, 'D',  0x6, 12, 0, 100);// Chan2 A sample maximum
    createConfigParam("Ch2:B:SampleMin",  2, 'D',  0x7, 12, 0, 100);// Chan2 B sample minimum
    createConfigParam("Ch2:B:SampleMax",  2, 'D',  0x8, 12, 0, 100);// Chan2 B sample maximum
    ...
    createConfigParam("Ch3:A:SampleMin",  3, 'D',  0x5, 12, 0, 100);// Chan3 A sample minimum
    createConfigParam("Ch3:A:SampleMax",  3, 'D',  0x6, 12, 0, 100);// Chan3 A sample maximum
    createConfigParam("Ch3:B:SampleMin",  3, 'D',  0x7, 12, 0, 100);// Chan3 B sample minimum
    createConfigParam("Ch3:B:SampleMax",  3, 'D',  0x8, 12, 0, 100);// Chan3 B sample maximum
    ...
    createConfigParam("Ch4:A:SampleMin",  4, 'D',  0x5, 12, 0, 100);// Chan4 A sample minimum
    createConfigParam("Ch4:A:SampleMax",  4, 'D',  0x6, 12, 0, 100);// Chan4 A sample maximum
    createConfigParam("Ch4:B:SampleMin",  4, 'D',  0x7, 12, 0, 100);// Chan4 B sample minimum
    createConfigParam("Ch4:B:SampleMax",  4, 'D',  0x8, 12, 0, 100);// Chan4 B sample maximum
    ...
    createConfigParam("Ch5:A:SampleMin",  5, 'D',  0x5, 12, 0, 100);// Chan5 A sample minimum
    createConfigParam("Ch5:A:SampleMax",  5, 'D',  0x6, 12, 0, 100);// Chan5 A sample maximum
    createConfigParam("Ch5:B:SampleMin",  5, 'D',  0x7, 12, 0, 100);// Chan5 B sample minimum
    createConfigParam("Ch5:B:SampleMax",  5, 'D',  0x8, 12, 0, 100);// Chan5 B sample maximum
    ...
    createConfigParam("Ch6:A:SampleMin",  6, 'D',  0x5, 12, 0, 100);// Chan6 A sample minimum
    createConfigParam("Ch6:A:SampleMax",  6, 'D',  0x6, 12, 0, 100);// Chan6 A sample maximum
    createConfigParam("Ch6:B:SampleMin",  6, 'D',  0x7, 12, 0, 100);// Chan6 B sample minimum
    createConfigParam("Ch6:B:SampleMax",  6, 'D',  0x8, 12, 0, 100);// Chan6 B sample maximum
    ...
    createConfigParam("Ch7:A:SampleMin",  7, 'D',  0x5, 12, 0, 100);// Chan7 A sample minimum
    createConfigParam("Ch7:A:SampleMax",  7, 'D',  0x6, 12, 0, 100);// Chan7 A sample maximum
    createConfigParam("Ch7:B:SampleMin",  7, 'D',  0x7, 12, 0, 100);// Chan7 B sample minimum
    createConfigParam("Ch7:B:SampleMax",  7, 'D',  0x8, 12, 0, 100);// Chan7 B sample maximum
    ...
    createConfigParam("Ch8:A:SampleMin",  8, 'D',  0x5, 12, 0, 100);// Chan8 A sample minimum
    createConfigParam("Ch8:A:SampleMax",  8, 'D',  0x6, 12, 0, 100);// Chan8 A sample maximum
    createConfigParam("Ch8:B:SampleMin",  8, 'D',  0x7, 12, 0, 100);// Chan8 B sample minimum
    createConfigParam("Ch8:B:SampleMax",  8, 'D',  0x8, 12, 0, 100);// Chan8 B sample maximum
