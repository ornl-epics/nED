...
//    BLXXX:Det:RocXXX:| sig nam|                              | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("Acquiring",            0x3,  1,  1); // Acquiring data               (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch1:Acquiring",        1, 0x3,  1,  2); // Chan1 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch2:Acquiring",        2, 0x3,  1,  2); // Chan2 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch3:Acquiring",        3, 0x3,  1,  2); // Chan3 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch4:Acquiring",        4, 0x3,  1,  2); // Chan4 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch5:Acquiring",        5, 0x3,  1,  2); // Chan5 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch6:Acquiring",        6, 0x3,  1,  2); // Chan6 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch7:Acquiring",        7, 0x3,  1,  2); // Chan7 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
    ...
    createStatusParam("Ch8:Acquiring",        8, 0x3,  1,  2); // Chan8 Acquiring data         (0=not acquiring [alarm],1=acquiring, archive:monitor)
...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("Ch1:A:InOffset",   1, '1',  0x2,  9, 0, 100);// Chan1 A input offset
    createConfigParam("Ch1:B:InOffset",   1, '1',  0x3,  9, 0, 100);// Chan1 B input offset
    createConfigParam("Ch1:A:FullScale",  1, '1',  0x4,  8, 0, 10); // Chan1 A full scale
    createConfigParam("Ch1:Sum:FullScale",1, '1',  0x5,  8, 0, 0);  // Chan1 SUM full scale
    createConfigParam("Ch1:B:FullScale",  1, '1',  0x6,  8, 0, 10); // Chan1 B full scale
    createConfigParam("Ch1:PosThreshold", 1, '1',  0x7,  8, 0, 400);// Chan1 positive threshold
    createConfigParam("Ch1:NegThreshold", 1, '1',  0x8,  8, 0, 0);  // Chan1 negative threshold
    createConfigParam("Ch1:A:AdcOffset",  1, '1',  0x9,  8, 0, 100);// Chan1 A ADC offset
    createConfigParam("Ch1:Sum:AdcOffset",1, '1',  0xA,  8, 0, 0);  // Chan1 sum zero
    createConfigParam("Ch1:B:AdcOffset",  1, '1',  0xB,  8, 0, 100);// Chan1 B ADC offset
    ...
    createConfigParam("Ch1:A:AvgMin",     1, '1',  0xE, 16, 0, 100);// Chan1 A average minimum
    createConfigParam("Ch1:B:AvgMin",     1, '1',  0xF, 16, 0, 100);  // Chan1 B average minimum
    createConfigParam("Ch1:A:AvgMax",     1, '1', 0x10, 16, 0, 1000); // Chan1 A average maximum
    createConfigParam("Ch1:B:AvgMax",     1, '1', 0x11, 16, 0, 1000); // Chan1 B average maximum
    ...
    createConfigParam("Ch1:A:SampleMax",  1, '1', 0x15, 10, 0, 4095); // Chan1 A sample maximum
    createConfigParam("Ch1:B:SampleMax",  1, '1', 0x16, 10, 0, 4095); // Chan1 B sample maximum
    ...
    createConfigParam("Ch1:VetoInhibit",  1, '8',  0x4, 12, 0, 0);  // Chan1 veto inhibit point
    ...
    createConfigParam("Ch2:A:InOffset",   2, '1',  0x2,  9, 0, 100);// Chan2 A input offset
    createConfigParam("Ch2:B:InOffset",   2, '1',  0x3,  9, 0, 100);// Chan2 B input offset
    createConfigParam("Ch2:A:FullScale",  2, '1',  0x4,  8, 0, 10); // Chan2 A full scale
    createConfigParam("Ch2:Sum:FullScale",2, '1',  0x5,  8, 0, 0);  // Chan2 SUM full scale
    createConfigParam("Ch2:B:FullScale",  2, '1',  0x6,  8, 0, 10); // Chan2 B full scale
    createConfigParam("Ch2:PosThreshold", 2, '1',  0x7,  8, 0, 400);// Chan2 positive threshold
    createConfigParam("Ch2:NegThreshold", 2, '1',  0x8,  8, 0, 0);  // Chan2 negative threshold
    createConfigParam("Ch2:A:AdcOffset",  2, '1',  0x9,  8, 0, 100);// Chan2 A ADC offset
    createConfigParam("Ch2:Sum:AdcOffset",2, '1',  0xA,  8, 0, 0);  // Chan2 sum zero
    createConfigParam("Ch2:B:AdcOffset",  2, '1',  0xB,  8, 0, 100);// Chan2 B ADC offset
    ...
    createConfigParam("Ch2:A:AvgMin",     2, '1',  0xE, 16, 0, 100);// Chan2 A average minimum
    createConfigParam("Ch2:B:AvgMin",     2, '1',  0xF, 16, 0, 100);  // Chan2 B average minimum
    createConfigParam("Ch2:A:AvgMax",     2, '1', 0x10, 16, 0, 1000); // Chan2 A average maximum
    createConfigParam("Ch2:B:AvgMax",     2, '1', 0x11, 16, 0, 1000); // Chan2 B average maximum
    ...
    createConfigParam("Ch2:A:SampleMax",  2, '1', 0x15, 10, 0, 4095); // Chan2 A sample maximum
    createConfigParam("Ch2:B:SampleMax",  2, '1', 0x16, 10, 0, 4095); // Chan2 B sample maximum
    ...
    createConfigParam("Ch2:MinDiscrimWidth",2,'8', 0x3,  9, 0, 1);  // Chan2 min pulse width
    createConfigParam("Ch2:VetoInhibit",  2, '8',  0x4, 12, 0, 0);  // Chan2 veto inhibit point
    ...
    createConfigParam("Ch3:A:InOffset",   3, '1',  0x2,  9, 0, 100);// Chan3 A input offset
    createConfigParam("Ch3:B:InOffset",   3, '1',  0x3,  9, 0, 100);// Chan3 B input offset
    createConfigParam("Ch3:A:FullScale",  3, '1',  0x4,  8, 0, 10); // Chan3 A full scale
    createConfigParam("Ch3:Sum:FullScale",3, '1',  0x5,  8, 0, 0);  // Chan3 SUM full scale
    createConfigParam("Ch3:B:FullScale",  3, '1',  0x6,  8, 0, 10); // Chan3 B full scale
    createConfigParam("Ch3:PosThreshold", 3, '1',  0x7,  8, 0, 400);// Chan3 positive threshold
    createConfigParam("Ch3:NegThreshold", 3, '1',  0x8,  8, 0, 0);  // Chan3 negative threshold
    createConfigParam("Ch3:A:AdcOffset",  3, '1',  0x9,  8, 0, 100);// Chan3 A ADC offset
    createConfigParam("Ch3:Sum:AdcOffset",3, '1',  0xA,  8, 0, 0);  // Chan3 sum zero
    createConfigParam("Ch3:B:AdcOffset",  3, '1',  0xB,  8, 0, 100);// Chan3 B ADC offset
    ...
    createConfigParam("Ch3:A:AvgMin",     3, '1',  0xE, 16, 0, 100);// Chan3 A average minimum
    createConfigParam("Ch3:B:AvgMin",     3, '1',  0xF, 16, 0, 100);  // Chan3 B average minimum
    createConfigParam("Ch3:A:AvgMax",     3, '1', 0x10, 16, 0, 1000); // Chan3 A average maximum
    createConfigParam("Ch3:B:AvgMax",     3, '1', 0x11, 16, 0, 1000); // Chan3 B average maximum
    ...
    createConfigParam("Ch3:A:SampleMax",  3, '1', 0x15, 10, 0, 4095); // Chan3 A sample maximum
    createConfigParam("Ch3:B:SampleMax",  3, '1', 0x16, 10, 0, 4095); // Chan3 B sample maximum
    ...
    createConfigParam("Ch3:MinDiscrimWidth",3,'8', 0x3,  9, 0, 1);  // Chan3 min pulse width
    createConfigParam("Ch3:VetoInhibit",  3, '8',  0x4, 12, 0, 0);  // Chan3 veto inhibit point
    ...
    createConfigParam("Ch4:A:InOffset",   4, '1',  0x2,  9, 0, 100);// Chan4 A input offset
    createConfigParam("Ch4:B:InOffset",   4, '1',  0x3,  9, 0, 100);// Chan4 B input offset
    createConfigParam("Ch4:A:FullScale",  4, '1',  0x4,  8, 0, 10); // Chan4 A full scale
    createConfigParam("Ch4:Sum:FullScale",4, '1',  0x5,  8, 0, 0);  // Chan4 SUM full scale
    createConfigParam("Ch4:B:FullScale",  4, '1',  0x6,  8, 0, 10); // Chan4 B full scale
    createConfigParam("Ch4:PosThreshold", 4, '1',  0x7,  8, 0, 400);// Chan4 positive threshold
    createConfigParam("Ch4:NegThreshold", 4, '1',  0x8,  8, 0, 0);  // Chan4 negative threshold
    createConfigParam("Ch4:A:AdcOffset",  4, '1',  0x9,  8, 0, 100);// Chan4 A ADC offset
    createConfigParam("Ch4:Sum:AdcOffset",4, '1',  0xA,  8, 0, 0);  // Chan4 sum zero
    createConfigParam("Ch4:B:AdcOffset",  4, '1',  0xB,  8, 0, 100);// Chan4 B ADC offset
    ...
    createConfigParam("Ch4:A:AvgMin",     4, '1',  0xE, 16, 0, 100);// Chan4 A average minimum
    createConfigParam("Ch4:B:AvgMin",     4, '1',  0xF, 16, 0, 100);  // Chan4 B average minimum
    createConfigParam("Ch4:A:AvgMax",     4, '1', 0x10, 16, 0, 1000); // Chan4 A average maximum
    createConfigParam("Ch4:B:AvgMax",     4, '1', 0x11, 16, 0, 1000); // Chan4 B average maximum
    ...
    createConfigParam("Ch4:A:SampleMax",  4, '1', 0x15, 10, 0, 4095); // Chan4 A sample maximum
    createConfigParam("Ch4:B:SampleMax",  4, '1', 0x16, 10, 0, 4095); // Chan4 B sample maximum
    ...
    createConfigParam("Ch4:MinDiscrimWidth",4,'8', 0x3,  9, 0, 1);  // Chan4 min pulse width
    createConfigParam("Ch4:VetoInhibit",  4, '8',  0x4, 12, 0, 0);  // Chan4 veto inhibit point
    ...
    createConfigParam("Ch5:A:InOffset",   5, '1',  0x2,  9, 0, 100);// Chan5 A input offset
    createConfigParam("Ch5:B:InOffset",   5, '1',  0x3,  9, 0, 100);// Chan5 B input offset
    createConfigParam("Ch5:A:FullScale",  5, '1',  0x4,  8, 0, 10); // Chan5 A full scale
    createConfigParam("Ch5:Sum:FullScale",5, '1',  0x5,  8, 0, 0);  // Chan5 SUM full scale
    createConfigParam("Ch5:B:FullScale",  5, '1',  0x6,  8, 0, 10); // Chan5 B full scale
    createConfigParam("Ch5:PosThreshold", 5, '1',  0x7,  8, 0, 400);// Chan5 positive threshold
    createConfigParam("Ch5:NegThreshold", 5, '1',  0x8,  8, 0, 0);  // Chan5 negative threshold
    createConfigParam("Ch5:A:AdcOffset",  5, '1',  0x9,  8, 0, 100);// Chan5 A ADC offset
    createConfigParam("Ch5:Sum:AdcOffset",5, '1',  0xA,  8, 0, 0);  // Chan5 sum zero
    createConfigParam("Ch5:B:AdcOffset",  5, '1',  0xB,  8, 0, 100);// Chan5 B ADC offset
    ...
    createConfigParam("Ch5:A:AvgMin",     5, '1',  0xE, 16, 0, 100);// Chan5 A average minimum
    createConfigParam("Ch5:B:AvgMin",     5, '1',  0xF, 16, 0, 100);  // Chan5 B average minimum
    createConfigParam("Ch5:A:AvgMax",     5, '1', 0x10, 16, 0, 1000); // Chan5 A average maximum
    createConfigParam("Ch5:B:AvgMax",     5, '1', 0x11, 16, 0, 1000); // Chan5 B average maximum
    ...
    createConfigParam("Ch5:A:SampleMax",  5, '1', 0x15, 10, 0, 4095); // Chan5 A sample maximum
    createConfigParam("Ch5:B:SampleMax",  5, '1', 0x16, 10, 0, 4095); // Chan5 B sample maximum
    ...
    createConfigParam("Ch5:MinDiscrimWidth",5,'8', 0x3,  9, 0, 1);  // Chan5 min pulse width
    createConfigParam("Ch5:VetoInhibit",  5, '8',  0x4, 12, 0, 0);  // Chan5 veto inhibit point
    ...
    createConfigParam("Ch6:A:InOffset",   6, '1',  0x2,  9, 0, 100);// Chan6 A input offset
    createConfigParam("Ch6:B:InOffset",   6, '1',  0x3,  9, 0, 100);// Chan6 B input offset
    createConfigParam("Ch6:A:FullScale",  6, '1',  0x4,  8, 0, 10); // Chan6 A full scale
    createConfigParam("Ch6:Sum:FullScale",6, '1',  0x5,  8, 0, 0);  // Chan6 SUM full scale
    createConfigParam("Ch6:B:FullScale",  6, '1',  0x6,  8, 0, 10); // Chan6 B full scale
    createConfigParam("Ch6:PosThreshold", 6, '1',  0x7,  8, 0, 400);// Chan6 positive threshold
    createConfigParam("Ch6:NegThreshold", 6, '1',  0x8,  8, 0, 0);  // Chan6 negative threshold
    createConfigParam("Ch6:A:AdcOffset",  6, '1',  0x9,  8, 0, 100);// Chan6 A ADC offset
    createConfigParam("Ch6:Sum:AdcOffset",6, '1',  0xA,  8, 0, 0);  // Chan6 sum zero
    createConfigParam("Ch6:B:AdcOffset",  6, '1',  0xB,  8, 0, 100);// Chan6 B ADC offset
    ...
    createConfigParam("Ch6:A:AvgMin",     6, '1',  0xE, 16, 0, 100);// Chan6 A average minimum
    createConfigParam("Ch6:B:AvgMin",     6, '1',  0xF, 16, 0, 100);  // Chan6 B average minimum
    createConfigParam("Ch6:A:AvgMax",     6, '1', 0x10, 16, 0, 1000); // Chan6 A average maximum
    createConfigParam("Ch6:B:AvgMax",     6, '1', 0x11, 16, 0, 1000); // Chan6 B average maximum
    ...
    createConfigParam("Ch6:A:SampleMax",  6, '1', 0x15, 10, 0, 4095); // Chan6 A sample maximum
    createConfigParam("Ch6:B:SampleMax",  6, '1', 0x16, 10, 0, 4095); // Chan6 B sample maximum
    ...
    createConfigParam("Ch6:MinDiscrimWidth",6,'8', 0x3,  9, 0, 1);  // Chan6 min pulse width
    createConfigParam("Ch6:VetoInhibit",  6, '8',  0x4, 12, 0, 0);  // Chan6 veto inhibit point
    ...
    createConfigParam("Ch7:A:InOffset",   7, '1',  0x2,  9, 0, 100);// Chan7 A input offset
    createConfigParam("Ch7:B:InOffset",   7, '1',  0x3,  9, 0, 100);// Chan7 B input offset
    createConfigParam("Ch7:A:FullScale",  7, '1',  0x4,  8, 0, 10); // Chan7 A full scale
    createConfigParam("Ch7:Sum:FullScale",7, '1',  0x5,  8, 0, 0);  // Chan7 SUM full scale
    createConfigParam("Ch7:B:FullScale",  7, '1',  0x6,  8, 0, 10); // Chan7 B full scale
    createConfigParam("Ch7:PosThreshold", 7, '1',  0x7,  8, 0, 400);// Chan7 positive threshold
    createConfigParam("Ch7:NegThreshold", 7, '1',  0x8,  8, 0, 0);  // Chan7 negative threshold
    createConfigParam("Ch7:A:AdcOffset",  7, '1',  0x9,  8, 0, 100);// Chan7 A ADC offset
    createConfigParam("Ch7:Sum:AdcOffset",7, '1',  0xA,  8, 0, 0);  // Chan7 sum zero
    createConfigParam("Ch7:B:AdcOffset",  7, '1',  0xB,  8, 0, 100);// Chan7 B ADC offset
    ...
    createConfigParam("Ch7:A:AvgMin",     7, '1',  0xE, 16, 0, 100);// Chan7 A average minimum
    createConfigParam("Ch7:B:AvgMin",     7, '1',  0xF, 16, 0, 100);  // Chan7 B average minimum
    createConfigParam("Ch7:A:AvgMax",     7, '1', 0x10, 16, 0, 1000); // Chan7 A average maximum
    createConfigParam("Ch7:B:AvgMax",     7, '1', 0x11, 16, 0, 1000); // Chan7 B average maximum
    ...
    createConfigParam("Ch7:A:SampleMax",  7, '1', 0x15, 10, 0, 4095); // Chan7 A sample maximum
    createConfigParam("Ch7:B:SampleMax",  7, '1', 0x16, 10, 0, 4095); // Chan7 B sample maximum
    ...
    createConfigParam("Ch7:MinDiscrimWidth",7,'8', 0x3,  9, 0, 1);  // Chan7 min pulse width
    createConfigParam("Ch7:VetoInhibit",  7, '8',  0x4, 12, 0, 0);  // Chan7 veto inhibit point
    ...
    createConfigParam("Ch8:A:InOffset",   8, '1',  0x2,  9, 0, 100);// Chan8 A input offset
    createConfigParam("Ch8:B:InOffset",   8, '1',  0x3,  9, 0, 100);// Chan8 B input offset
    createConfigParam("Ch8:A:FullScale",  8, '1',  0x4,  8, 0, 10); // Chan8 A full scale
    createConfigParam("Ch8:Sum:FullScale",8, '1',  0x5,  8, 0, 0);  // Chan8 SUM full scale
    createConfigParam("Ch8:B:FullScale",  8, '1',  0x6,  8, 0, 10); // Chan8 B full scale
    createConfigParam("Ch8:PosThreshold", 8, '1',  0x7,  8, 0, 400);// Chan8 positive threshold
    createConfigParam("Ch8:NegThreshold", 8, '1',  0x8,  8, 0, 0);  // Chan8 negative threshold
    createConfigParam("Ch8:A:AdcOffset",  8, '1',  0x9,  8, 0, 100);// Chan8 A ADC offset
    createConfigParam("Ch8:Sum:AdcOffset",8, '1',  0xA,  8, 0, 0);  // Chan8 sum zero
    createConfigParam("Ch8:B:AdcOffset",  8, '1',  0xB,  8, 0, 100);// Chan8 B ADC offset
    ...
    createConfigParam("Ch8:A:AvgMin",     8, '1',  0xE, 16, 0, 100);// Chan8 A average minimum
    createConfigParam("Ch8:B:AvgMin",     8, '1',  0xF, 16, 0, 100);  // Chan8 B average minimum
    createConfigParam("Ch8:A:AvgMax",     8, '1', 0x10, 16, 0, 1000); // Chan8 A average maximum
    createConfigParam("Ch8:B:AvgMax",     8, '1', 0x11, 16, 0, 1000); // Chan8 B average maximum
    ...
    createConfigParam("Ch8:A:SampleMax",  8, '1', 0x15, 10, 0, 4095); // Chan8 A sample maximum
    createConfigParam("Ch8:B:SampleMax",  8, '1', 0x16, 10, 0, 4095); // Chan8 B sample maximum
    ...
    createConfigParam("Ch8:MinDiscrimWidth",8,'8', 0x3,  9, 0, 1);  // Chan8 min pulse width
    createConfigParam("Ch8:VetoInhibit",  8, '8',  0x4, 12, 0, 0);  // Chan8 veto inhibit point
