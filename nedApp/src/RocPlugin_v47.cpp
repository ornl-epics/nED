...
void RocPlugin::createParams_v47()
{
    ...
    createRegParam("VERSION", "FwRev",  true, 1,  8, 0);   // Firmware revision        (low:6,high:8)
...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("TsyncDelay",       'E',  0x6,  32, 0, 0);    // TSYNC delay                   (scale:100,unit:ns,prec:1)
    ...
    createChanConfigParam("Ch1:A:SampleMin",  1, '1', 0x13, 10, 0, 0);      // Chan1 A sample minimum
    createChanConfigParam("Ch1:B:SampleMin",  1, '1', 0x14, 10, 0, 0);      // Chan1 B sample minimum
    createChanConfigParam("Ch1:A:SampleMax",  1, '1', 0x15, 10, 0, 0);      // Chan1 A sample maximum
    createChanConfigParam("Ch1:B:SampleMax",  1, '1', 0x16, 10, 0, 0);      // Chan1 B sample maximum
    ...
    createChanConfigParam("Ch1:CorrectRate",  1, '8',  0x8,  2, 0, 1);      // Chan1 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch1:TpCtrl",       1, '8',  0x8,  4,12, 3);      // Chan1 TP control
    ...
    createChanConfigParam("Ch2:A:SampleMin",  2, '1', 0x13, 10, 0, 0);      // Chan2 A sample minimum
    createChanConfigParam("Ch2:B:SampleMin",  2, '1', 0x14, 10, 0, 0);      // Chan2 B sample minimum
    createChanConfigParam("Ch2:A:SampleMax",  2, '1', 0x15, 10, 0, 0);      // Chan2 A sample maximum
    createChanConfigParam("Ch2:B:SampleMax",  2, '1', 0x16, 10, 0, 0);      // Chan2 B sample maximum
    ...
    createChanConfigParam("Ch2:CorrectRate",  2, '8',  0x8,  2, 0, 1);      // Chan2 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch2:TpCtrl",       2, '8',  0x8,  4,12, 3);      // Chan2 TP control
    ...
    createChanConfigParam("Ch3:A:SampleMin",  3, '1', 0x13, 10, 0, 0);      // Chan3 A sample minimum
    createChanConfigParam("Ch3:B:SampleMin",  3, '1', 0x14, 10, 0, 0);      // Chan3 B sample minimum
    createChanConfigParam("Ch3:A:SampleMax",  3, '1', 0x15, 10, 0, 0);      // Chan3 A sample maximum
    createChanConfigParam("Ch3:B:SampleMax",  3, '1', 0x16, 10, 0, 0);      // Chan3 B sample maximum
    ...
    createChanConfigParam("Ch3:CorrectRate",  3, '8',  0x8,  2, 0, 1);      // Chan3 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch3:TpCtrl",       3, '8',  0x8,  4,12, 3);      // Chan3 TP control
    ...
    createChanConfigParam("Ch4:A:SampleMin",  4, '1', 0x13, 10, 0, 0);      // Chan4 A sample minimum
    createChanConfigParam("Ch4:B:SampleMin",  4, '1', 0x14, 10, 0, 0);      // Chan4 B sample minimum
    createChanConfigParam("Ch4:A:SampleMax",  4, '1', 0x15, 10, 0, 0);      // Chan4 A sample maximum
    createChanConfigParam("Ch4:B:SampleMax",  4, '1', 0x16, 10, 0, 0);      // Chan4 B sample maximum
    ...
    createChanConfigParam("Ch4:CorrectRate",  4, '8',  0x8,  2, 0, 1);      // Chan4 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch4:TpCtrl",       4, '8',  0x8,  4,12, 3);      // Chan4 TP control
    ...
    createChanConfigParam("Ch5:A:SampleMin",  5, '1', 0x13, 10, 0, 0);      // Chan5 A sample minimum
    createChanConfigParam("Ch5:B:SampleMin",  5, '1', 0x14, 10, 0, 0);      // Chan5 B sample minimum
    createChanConfigParam("Ch5:A:SampleMax",  5, '1', 0x15, 10, 0, 0);      // Chan5 A sample maximum
    createChanConfigParam("Ch5:B:SampleMax",  5, '1', 0x16, 10, 0, 0);      // Chan5 B sample maximum
    ...
    createChanConfigParam("Ch5:CorrectRate",  5, '8',  0x8,  2, 0, 1);      // Chan5 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch5:TpCtrl",       5, '8',  0x8,  4,12, 3);      // Chan5 TP control
    ...
    createChanConfigParam("Ch6:A:SampleMin",  6, '1', 0x13, 10, 0, 0);      // Chan6 A sample minimum
    createChanConfigParam("Ch6:B:SampleMin",  6, '1', 0x14, 10, 0, 0);      // Chan6 B sample minimum
    createChanConfigParam("Ch6:A:SampleMax",  6, '1', 0x15, 10, 0, 0);      // Chan6 A sample maximum
    createChanConfigParam("Ch6:B:SampleMax",  6, '1', 0x16, 10, 0, 0);      // Chan6 B sample maximum
    ...
    createChanConfigParam("Ch6:CorrectRate",  6, '8',  0x8,  2, 0, 1);      // Chan6 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch6:TpCtrl",       6, '8',  0x8,  4,12, 3);      // Chan6 TP control
    ...
    createChanConfigParam("Ch7:A:SampleMin",  7, '1', 0x13, 10, 0, 0);      // Chan7 A sample minimum
    createChanConfigParam("Ch7:B:SampleMin",  7, '1', 0x14, 10, 0, 0);      // Chan7 B sample minimum
    createChanConfigParam("Ch7:A:SampleMax",  7, '1', 0x15, 10, 0, 0);      // Chan7 A sample maximum
    createChanConfigParam("Ch7:B:SampleMax",  7, '1', 0x16, 10, 0, 0);      // Chan7 B sample maximum
    ...
    createChanConfigParam("Ch7:CorrectRate",  7, '8',  0x8,  2, 0, 1);      // Chan7 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch7:TpCtrl",       7, '8',  0x8,  4,12, 3);      // Chan7 TP control
    ...
    createChanConfigParam("Ch8:A:SampleMin",  8, '1', 0x13, 10, 0, 0);      // Chan8 A sample minimum
    createChanConfigParam("Ch8:B:SampleMin",  8, '1', 0x14, 10, 0, 0);      // Chan8 B sample minimum
    createChanConfigParam("Ch8:A:SampleMax",  8, '1', 0x15, 10, 0, 0);      // Chan8 A sample maximum
    createChanConfigParam("Ch8:B:SampleMax",  8, '1', 0x16, 10, 0, 0);      // Chan8 B sample maximum
    ...
    createChanConfigParam("Ch8:CorrectRate",  8, '8',  0x8,  2, 0, 1);      // Chan8 Auto correction rate     (0=off, 1=TSYNC, 2=approx 1.2ms, 3=unknown)
    createChanConfigParam("Ch8:TpCtrl",       8, '8',  0x8,  4,12, 3);      // Chan8 TP control
