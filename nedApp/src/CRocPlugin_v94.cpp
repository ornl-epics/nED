...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createCounterParam("Y1:RateTrigger",     0xD, 16,  0); // PMT ch0 trigger rate
    createCounterParam("Y2:RateTrigger",     0xE, 16,  0); // PMT ch1 trigger rate
    createCounterParam("Y3:RateTrigger",     0xF, 16,  0); // PMT ch2 trigger rate
    createCounterParam("Y4:RateTrigger",    0x10, 16,  0); // PMT ch3 trigger rate
    createCounterParam("Y5:RateTrigger",    0x11, 16,  0); // PMT ch4 trigger rate
    createCounterParam("Y6:RateTrigger",    0x12, 16,  0); // PMT ch5 trigger rate
    createCounterParam("Y7:RateTrigger",    0x13, 16,  0); // PMT ch6 trigger rate
    createCounterParam("X1:RateTrigger",    0x14, 16,  0); // PMT ch7 trigger rate
    createCounterParam("X2:RateTrigger",    0x15, 16,  0); // PMT ch8 trigger rate
    createCounterParam("X3:RateTrigger",    0x16, 16,  0); // PMT ch9 trigger rate
    createCounterParam("X4:RateTrigger",    0x17, 16,  0); // PMT ch10 trigger rate
    createCounterParam("X5:RateTrigger",    0x18, 16,  0); // PMT ch11 trigger rate
    createCounterParam("X6:RateTrigger",    0x19, 16,  0); // PMT ch12 trigger rate
    createCounterParam("X7:RateTrigger",    0x1A, 16,  0); // PMT ch13 trigger rate
    createCounterParam("X8:RateTrigger",    0x1B, 16,  0); // PMT ch14 trigger rate
    createCounterParam("X9:RateTrigger",    0x1C, 16,  0); // PMT ch15 trigger rate
    createCounterParam("X10:RateTrigger",   0x1D, 16,  0); // PMT ch16 trigger rate
    createCounterParam("X11:RateTrigger",   0x1E, 16,  0); // PMT ch17 trigger rate
    createCounterParam("G1:RateTrigger",    0x1F, 16,  0); // PMT ch18 trigger rate
    createCounterParam("G2:RateTrigger",    0x20, 16,  0); // PMT ch19 trigger rate
    createCounterParam("G3:RateTrigger",    0x21, 16,  0); // PMT ch20 trigger rate
    createCounterParam("G4:RateTrigger",    0x22, 16,  0); // PMT ch21 trigger rate
    createCounterParam("G5:RateTrigger",    0x23, 16,  0); // PMT ch22 trigger rate
    createCounterParam("G6:RateTrigger",    0x24, 16,  0); // PMT ch23 trigger rate
    createCounterParam("G7:RateTrigger",    0x25, 16,  0); // PMT ch24 trigger rate
    createCounterParam("G8:RateTrigger",    0x26, 16,  0); // PMT ch25 trigger rate
    createCounterParam("G9:RateTrigger",    0x27, 16,  0); // PMT ch26 trigger rate
    createCounterParam("G10:RateTrigger",   0x28, 16,  0); // PMT ch27 trigger rate
    createCounterParam("G11:RateTrigger",   0x29, 16,  0); // PMT ch28 trigger rate
    createCounterParam("G12:RateTrigger",   0x2A, 16,  0); // PMT ch29 trigger rate
    createCounterParam("G13:RateTrigger",   0x2B, 16,  0); // PMT ch30 trigger rate
    createCounterParam("G14:RateTrigger",   0x2C, 16,  0); // PMT ch31 trigger rate
    createCounterParam("RateTrigger",       0x2D, 16,  0); // All PMTs trigger rate
}
