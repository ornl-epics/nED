...
void RocPlugin::createConfigExParams_v57()
{
    createConfigParamEx("TestPatternAltEn", '1', 0x0,  1, 14, 0);     // Test pattern alt enable      (0=disable,1=enable)
    createConfigParamEx("TestPatternEn",    '1', 0x0,  1, 15, 0);     // Test pattern enable          (0=disable,1=enable)
    createConfigParamEx("TestPatternId",    '1', 0x0, 12, 0,  0);     // Test pattern id
    createConfigParamEx("TestPatternRate",  '1', 0x1, 16, 0,  0);     // Test pattern rate
}
