...
void RocPlugin::createParams_v57()
{
    ...
    createRegParam("VERSION", "FwRev",  true, 1,  8, 0);   // Hardware revision        (low:0,high:2)
    createRegParam("VERSION", "FwVer",  true, 1,  8, 8);   // Hardware revision        (low:6,high:8)
...
//    BLXXX:Det:RocXXX:| sig nam |                         | EPICS record description  | (bi and mbbi description)
    ...
    createStatusParam("Configured",       0x0,  1,  9); // Configured                    (0=not configured,1=configured, archive:monitor)
    ...
    createCounterParam("Ch0:CntDiscSum",   0xC, 16,  0); // Ch0 SUM discriminator rate    (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch1:CntDiscSum",   0xD, 16,  0); // Ch1 SUM discriminator rate    (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch2:CntDiscSum",   0xE, 16,  0); // Ch2 SUM discriminator rate    (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch3:CntDiscSum",   0xF, 16,  0); // Ch3 SUM discriminator rate    (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch4:CntDiscSum",   0x10, 16,  0); // Ch4 SUM discriminator rate   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch5:CntDiscSum",   0x11, 16,  0); // Ch5 SUM discriminator rate   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch6:CntDiscSum",   0x12, 16,  0); // Ch6 SUM discriminator rate   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch7:CntDiscSum",   0x13, 16,  0); // Ch7 SUM discriminator rate   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch0:CntRate",      0x14, 16,  0); // Ch0 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch1:CntRate",      0x15, 16,  0); // Ch1 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch2:CntRate",      0x16, 16,  0); // Ch2 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch3:CntRate",      0x17, 16,  0); // Ch3 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch4:CntRate",      0x18, 16,  0); // Ch4 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch5:CntRate",      0x19, 16,  0); // Ch5 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch6:CntRate",      0x1A, 16,  0); // Ch6 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("Ch7:CntRate",      0x1B, 16,  0); // Ch7 outrate counter   (calc:1000*A/52.4288,unit:cnts/s,prec:1)
    createCounterParam("CntOutRate",       0x1C, 16,  0); // Total outrate counter (calc:1000*A/52.4288,unit:cnts/s,prec:1)
