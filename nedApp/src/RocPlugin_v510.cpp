...
/**
 * @file RocPlugin_v510.cpp
 *
 * ROC 5.10 parameters
 *
 * The ROC 5.10 firmware is same as 5.9 except for CORELLI type of ROC
 */

void RocPlugin::createParams_v510()
{
    createRegParam("VERSION", "HwRev",  true, 0,  8, 0);   // Hardware revision
    createRegParam("VERSION", "HwVer",  true, 0,  8, 8);   // Hardware version
    createRegParam("VERSION", "FwRev",  true, 1,  8, 0);   // Firmware revision        (low:9,high:11)
