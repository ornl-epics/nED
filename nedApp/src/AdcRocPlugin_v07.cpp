...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("Adc0:RateIdle",      'D', 0x1, 16,  0, 1000); // Chan0 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc1:RateIdle",      'D', 0x2, 16,  0, 1000); // Chan1 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc2:RateIdle",      'D', 0x3, 16,  0, 1000); // Chan2 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc3:RateIdle",      'D', 0x4, 16,  0, 1000); // Chan3 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc4:RateIdle",      'D', 0x5, 16,  0, 1000); // Chan4 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc5:RateIdle",      'D', 0x6, 16,  0, 1000); // Chan5 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc6:RateIdle",      'D', 0x7, 16,  0, 1000); // Chan6 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    createConfigParam("Adc7:RateIdle",      'D', 0x8, 16,  0, 1000); // Chan7 ADC Idle Rate             (calcwrite:100000/(A+1),calcread:(100000/A)-1,unit:Hz)
    ...
    createConfigParam("NmosOnWidth",        'E', 0x3, 24,  0, 0);   // NMOS_ON pulse width              (scale:100,offset:100,unit:ns)
    createConfigParam("PmosOnWidth",        'E', 0x5, 10,  0, 0);   // PMOS_ON pulse width              (scale:100,offset:100,unit:ns)
    createConfigParam("NmosOnDelay",        'E', 0x5,  4, 12, 0);   // NMOS pulse delay after PMOS      (scale:100,offset:100,unit:ns)
