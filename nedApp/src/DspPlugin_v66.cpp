...
//      BLXXX:Det:DspX:| sig nam|                            | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("OptDataFormat",  'E', 0x8,  4, 20, 0); // Data format                  (0=legacy,1=meta,2=pixel,3=XY,4=XY PS,5=LPSD raw,6=LPSD verbose,7=AROC raw,8=AROC verbose,9=BNL raw,10=BNL verbose,11=CROC raw,12=CROC verbose)
...
//      BLXXX:Det:DspX:| sig nam|                     | EPICS record description | (bi and mbbi description)
    ...
    createCounterParam("SCounters106",    0x35, 24,  0); // TBD
    createCounterParam("SCounters108",    0x36, 24,  0); // TBD
