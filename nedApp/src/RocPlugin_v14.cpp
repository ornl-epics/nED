...
//    BLXXX:Det:RocXXX:| sig nam|                              | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("Ch1:MultiDiscEvent",   1, 0x0,  1,  5); // Chan1 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch1:AdcMin",           1, 0x0,  1,  6); // Chan1 got ADC min            (0=no,1=yes)
    createStatusParam("Ch1:AdcMax",           1, 0x0,  1,  7); // Chan1 got ADC max            (0=no,1=yes)
    createStatusParam("Ch1:EventFifoFull",    1, 0x0,  1,  8); // Chan1 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch1:NegDiscEvent",     1, 0x0,  1,  9); // Chan1 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch1:PosDiscEvent",     1, 0x0,  1, 10); // Chan1 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch1:TofOverflow",      1, 0x0,  1, 14); // Chan1 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch2:MultiDiscEvent",   2, 0x0,  1,  5); // Chan2 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch2:AdcMin",           2, 0x0,  1,  6); // Chan2 got ADC min            (0=no,1=yes)
    createStatusParam("Ch2:AdcMax",           2, 0x0,  1,  7); // Chan2 got ADC max            (0=no,1=yes)
    createStatusParam("Ch2:EventFifoFull",    2, 0x0,  1,  8); // Chan2 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch2:NegDiscEvent",     2, 0x0,  1,  9); // Chan2 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch2:PosDiscEvent",     2, 0x0,  1, 10); // Chan2 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch2:TofOverflow",      2, 0x0,  1, 14); // Chan2 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch3:MultiDiscEvent",   3, 0x0,  1,  5); // Chan3 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch3:AdcMin",           3, 0x0,  1,  6); // Chan3 got ADC min            (0=no,1=yes)
    createStatusParam("Ch3:AdcMax",           3, 0x0,  1,  7); // Chan3 got ADC max            (0=no,1=yes)
    createStatusParam("Ch3:EventFifoFull",    3, 0x0,  1,  8); // Chan3 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch3:NegDiscEvent",     3, 0x0,  1,  9); // Chan3 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch3:PosDiscEvent",     3, 0x0,  1, 10); // Chan3 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch3:TofOverflow",      3, 0x0,  1, 14); // Chan3 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch4:MultiDiscEvent",   4, 0x0,  1,  5); // Chan4 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch4:AdcMin",           4, 0x0,  1,  6); // Chan4 got ADC min            (0=no,1=yes)
    createStatusParam("Ch4:AdcMax",           4, 0x0,  1,  7); // Chan4 got ADC max            (0=no,1=yes)
    createStatusParam("Ch4:EventFifoFull",    4, 0x0,  1,  8); // Chan4 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch4:NegDiscEvent",     4, 0x0,  1,  9); // Chan4 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch4:PosDiscEvent",     4, 0x0,  1, 10); // Chan4 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch4:TofOverflow",      4, 0x0,  1, 14); // Chan4 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch5:MultiDiscEvent",   5, 0x0,  1,  5); // Chan5 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch5:AdcMin",           5, 0x0,  1,  6); // Chan5 got ADC min            (0=no,1=yes)
    createStatusParam("Ch5:AdcMax",           5, 0x0,  1,  7); // Chan5 got ADC max            (0=no,1=yes)
    createStatusParam("Ch5:EventFifoFull",    5, 0x0,  1,  8); // Chan5 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch5:NegDiscEvent",     5, 0x0,  1,  9); // Chan5 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch5:PosDiscEvent",     5, 0x0,  1, 10); // Chan5 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch5:TofOverflow",      5, 0x0,  1, 14); // Chan5 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch6:MultiDiscEvent",   6, 0x0,  1,  5); // Chan6 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch6:AdcMin",           6, 0x0,  1,  6); // Chan6 got ADC min            (0=no,1=yes)
    createStatusParam("Ch6:AdcMax",           6, 0x0,  1,  7); // Chan6 got ADC max            (0=no,1=yes)
    createStatusParam("Ch6:EventFifoFull",    6, 0x0,  1,  8); // Chan6 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch6:NegDiscEvent",     6, 0x0,  1,  9); // Chan6 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch6:PosDiscEvent",     6, 0x0,  1, 10); // Chan6 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch6:TofOverflow",      6, 0x0,  1, 14); // Chan6 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch7:MultiDiscEvent",   7, 0x0,  1,  5); // Chan7 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch7:AdcMin",           7, 0x0,  1,  6); // Chan7 got ADC min            (0=no,1=yes)
    createStatusParam("Ch7:AdcMax",           7, 0x0,  1,  7); // Chan7 got ADC max            (0=no,1=yes)
    createStatusParam("Ch7:EventFifoFull",    7, 0x0,  1,  8); // Chan7 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch7:NegDiscEvent",     7, 0x0,  1,  9); // Chan7 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch7:PosDiscEvent",     7, 0x0,  1, 10); // Chan7 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch7:TofOverflow",      7, 0x0,  1, 14); // Chan7 TOF overflow           (0=no,1=yes)
    ...
    createStatusParam("Ch8:MultiDiscEvent",   8, 0x0,  1,  5); // Chan8 got multi-discrim ev   (0=no,1=yes)
    createStatusParam("Ch8:AdcMin",           8, 0x0,  1,  6); // Chan8 got ADC min            (0=no,1=yes)
    createStatusParam("Ch8:AdcMax",           8, 0x0,  1,  7); // Chan8 got ADC max            (0=no,1=yes)
    createStatusParam("Ch8:EventFifoFull",    8, 0x0,  1,  8); // Chan8 FIFO full detectec     (0=no,1=yes)
    createStatusParam("Ch8:NegDiscEvent",     8, 0x0,  1,  9); // Chan8 negative discrim ev    (0=no,1=yes)
    createStatusParam("Ch8:PosDiscEvent",     8, 0x0,  1, 10); // Chan8 positive discrim ev    (0=no,1=yes)
    ...
    createStatusParam("Ch8:TofOverflow",      8, 0x0,  1, 14); // Chan8 TOF overflow           (0=no,1=yes)
    createStatusParam("Ch8:AdcFifoFull",      8, 0x0,  1, 15); // Chan8 FIFO full detectec     (0=no,1=yes)
