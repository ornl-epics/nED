...
/**
 * @file FemPlugin_v310.cpp
 *
 * FEM 3.10 parameters
 *
 * The FEM 3.10 firmware is identical to FEM 3.9 but id adds registers for
 * disabling TX channels.
 */

#include "FemPlugin.h"

void FemPlugin::createParams_v310()
{
    ...
    createRegParam("VERSION", "FwRev",  true, 3,  8,  0); // Firmware revision                  (low:9,high:11)
...
//     BLXXX:Det:FemXX:| sig name |                                | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("Lvds1:En",          'F', 0x0,  1,  4, 0);  // Chan1 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds2:En",          'F', 0x0,  1,  5, 0);  // Chan2 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds3:En",          'F', 0x0,  1,  6, 0);  // Chan3 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds4:En",          'F', 0x0,  1,  7, 0);  // Chan4 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds5:En",          'F', 0x0,  1,  8, 0);  // Chan5 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds6:En",          'F', 0x0,  1,  9, 0);  // Chan6 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds7:En",          'F', 0x0,  1, 10, 0);  // Chan7 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds8:En",          'F', 0x0,  1, 11, 0);  // Chan8 RX disable             (0=enable,1=disable)
    createConfigParam("Lvds9:En",          'F', 0x0,  1, 12, 0);  // Chan9 RX disable             (0=enable,1=disable)
    ...
    createConfigParam("Upg:Enable",        'F', 0x3,  1,  0, 0);  // Remote update enable switch  (0=disable,1=enable)
    createConfigParam("Upg:Check",         'F', 0x3,  1,  1, 0);  // Rem. u. check basic connect  (0=disable,1=enable)
    createConfigParam("Upg:Verify",        'F', 0x3,  1,  2, 0);  // Rem. u. valid image check    (0=disable,1=enable)
    createConfigParam("Upg:Reset",         'F', 0x3,  1,  3, 0);  // Rem. u. flash FIFO reset     (0=disable,1=enable)
    createConfigParam("Lvds1:TxEn",        'F', 0x3,  1,  4, 0);  // Chan1 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds2:TxEn",        'F', 0x3,  1,  5, 0);  // Chan2 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds3:TxEn",        'F', 0x3,  1,  6, 0);  // Chan3 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds4:TxEn",        'F', 0x3,  1,  7, 0);  // Chan4 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds5:TxEn",        'F', 0x3,  1,  8, 0);  // Chan5 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds6:TxEn",        'F', 0x3,  1,  9, 0);  // Chan6 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds7:TxEn",        'F', 0x3,  1, 10, 0);  // Chan7 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds8:TxEn",        'F', 0x3,  1, 11, 0);  // Chan8 TX disable             (0=enable,1=disable)
    createConfigParam("Lvds9:TxEn",        'F', 0x3,  1, 12, 0);  // Chan9 TX disable             (0=enable,1=disable)
