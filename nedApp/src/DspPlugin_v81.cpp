...
//      BLXXX:Det:DspX:| sig nam|         '1' addr  size off default      | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("TimeMode",         '1', 0x15,  2, 30, 0); // Select timing mode          (0=NTP test mode,1=lab test mode,2=invalid,3=NTP run mode)
    ...
    createConfigParam("Time:El:Source",   '1', 0x1A,  1, 26, 0); // RTDL EL Source              (0=internal,1=external)
    createConfigParam("Time:Rtdl:TxEn",   '1', 0x1A,  1, 27, 0); // RTDL SFP TX disable         (0=enable,1=disable)
    createConfigParam("Time:El:TxEn",     '1', 0x1A,  1, 28, 0); // EL SFP TX disable           (0=enable,1=disable)
