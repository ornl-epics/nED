...
void DspPlugin::createParams_v81() {
...
//      BLXXX:Det:DspX:| sig nam|         '1' addr  size off default      | EPICS record description | (bi and mbbi description)
    ...
    createConfigParam("TimeMode",         '1', 0x15,  2, 30, 0); // Select timing mode          (0=NTP test mode,1=invalid,2=lab test mode,3=NTP run mode)
    ...
    createConfigParam("RTDL_EL_Source",   '1', 0x1A,  1, 26, 0); // RTDL EL Source              (0=internal,1=external)
    createConfigParam("RTDL_SFP_TX_Dis",  '1', 0x1A,  1, 27, 0); // RTDL SFP TX disable         (0=enable,1=disable)
    createConfigParam("EL_SFP_TX_Dis",    '1', 0x1A,  1, 28, 0); // EL SFP TX disable           (0=enable,1=disable)
...
//      BLXXX:Det:DspX:| sig nam|          addr size off  | EPICS record description | (bi and mbbi description)
    ...
    createStatusParam("TsyncCountsInt",    0x4,  32,  0); // Tsync Count in 10m Internal Clocks
    createStatusParam("TsyncCountsExt",    0x5,  32,  0); // Tsync Count in 10m RTDL Clocks
