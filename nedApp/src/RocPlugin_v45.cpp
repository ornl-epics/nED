...
//    BLXXX:Det:RocXXX:| sig nam |                                     | EPICS record description  | (bi and mbbi description)
    ...
    createConfigParam("Ch1:A:AvgMin",     1, '1',  0xE, 12, 0, 100);// Chan1 A average minimum
    createConfigParam("Ch1:A:AvgMax",     1, '1',  0xF, 12, 0, 1000); // Chan1 A average maximum
    ...
    createConfigParam("Ch2:A:AvgMin",     2, '1',  0xE, 12, 0, 100);// Chan2 A average minimum
    createConfigParam("Ch2:A:AvgMax",     2, '1',  0xF, 12, 0, 1000); // Chan2 A average maximum
    ...
    createConfigParam("Ch2:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan2 min pulse width
    ...
    createConfigParam("Ch3:A:AvgMin",     3, '1',  0xE, 12, 0, 100);// Chan3 A average minimum
    createConfigParam("Ch3:A:AvgMax",     3, '1',  0xF, 12, 0, 1000); // Chan3 A average maximum
    ...
    createConfigParam("Ch3:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan3 min pulse width
    ...
    createConfigParam("Ch4:A:AvgMin",     4, '1',  0xE, 12, 0, 100);// Chan4 A average minimum
    createConfigParam("Ch4:A:AvgMax",     4, '1',  0xF, 12, 0, 1000); // Chan4 A average maximum
    ...
    createConfigParam("Ch4:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan4 min pulse width
    ...
    createConfigParam("Ch5:A:AvgMin",     5, '1',  0xE, 12, 0, 100);// Chan5 A average minimum
    createConfigParam("Ch5:A:AvgMax",     5, '1',  0xF, 12, 0, 1000); // Chan5 A average maximum
    ...
    createConfigParam("Ch5:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan5 min pulse width
    ...
    createConfigParam("Ch6:A:AvgMin",     6, '1',  0xE, 12, 0, 100);// Chan6 A average minimum
    createConfigParam("Ch6:A:AvgMax",     6, '1',  0xF, 12, 0, 1000); // Chan6 A average maximum
    ...
    createConfigParam("Ch6:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan6 min pulse width
    ...
    createConfigParam("Ch7:A:AvgMin",     7, '1',  0xE, 12, 0, 100);// Chan7 A average minimum
    createConfigParam("Ch7:A:AvgMax",     7, '1',  0xF, 12, 0, 1000); // Chan7 A average maximum
    ...
    createConfigParam("Ch7:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan7 min pulse width
    ...
    createConfigParam("Ch8:A:AvgMin",     8, '1',  0xE, 12, 0, 100);// Chan8 A average minimum
    createConfigParam("Ch8:A:AvgMax",     8, '1',  0xF, 12, 0, 1000); // Chan8 A average maximum
    ...
    createConfigParam("Ch8:MinDiscrimWidth",1,'8', 0x3,  9, 0, 1);  // Chan8 min pulse width
